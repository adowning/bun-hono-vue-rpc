          ...
          <div class="space-y-2">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-medium"
                >${{ playerData.balance.depositWageringRemaining.toFixed(2) }}</span
              >
            </div>
          </div>
        </el-card>
          ...
          <div class="space-y-2">
            <div class="flex justify-between">
              ...
              <span class="font-medium text-green-500"
                >${{ playerData.balance.totalDepositedReal.toFixed(2) }}</span
              >
            </div>
            <div class="flex justify-between">
              <span class="text-tx-secondary">Total Withdrawn</span>
              <span class="font-medium text-red-500"
                >${{ playerData.balance.totalWithdrawn.toFixed(2) }}</span
              >
            </div>
            <div class="flex justify-between">
