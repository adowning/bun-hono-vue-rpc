...
//       await (client.value as any).connect()

//       (client.value as any).on('getMe', (msg: any) => {
//         // ✅ msg.payload.greeting is typed as string
//         console.log(msg.payload)
//       })
//       const reply = await (client.value as any).request('getMe', undefined, { timeoutMs: 5000 })
//     } catch (err) {
//       console.error(err)
//       //   connectToSocket()
//     }
//     (client.value as any).onopen = () => {
//       console.log('requestintg')
//       requestEverything()
//     }

//     (client.value as any).onmessage = (event: any) => {
