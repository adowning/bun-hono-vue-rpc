<!-- 登录、注册、忘记密码左侧背景 -->
<template>
  <div class="login-left-view" style="background: #030518 !important">
    <div class="logo" style="background: #030518 !important">
      <ArtLogo class="icon" size="46" style="background: #030518 !important" />
      <!-- <h1 class="title" style="background: #030518 !important">{{ AppConfig.systemInfo.name }}</h1> -->
    </div>
    ...
    <!-- <div class="text-wrap" style="background: #030518 !important">
