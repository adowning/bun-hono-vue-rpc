...
<template>
  ...
  >
    ...
    <div
      ...
      :style="{ width: dualMenuShowText ? '80px' : '64px' }"
      style="background: #030518"
    >
      <ArtLogo class="logo" @click="navigateToHome" style="background: #030518 !important" />
    ...
    >
      <ElScrollbar style="height: calc(100% - 10px)">
        <div
          ...
          style="background: #030518 !important"
          :style="{ background: getMenuTheme.background }"
        >
          <ArtLogo v-if="!isDualMenu" class="logo" style="background: #030518 !important" />
