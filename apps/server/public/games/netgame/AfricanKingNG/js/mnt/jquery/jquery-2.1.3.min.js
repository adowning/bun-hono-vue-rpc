  ...
  new (function () {
    ...
    this.init = function () {
      function c() {
        ...
        var f = n[k]
        k++
        $.ajax({ url: f.file, type: 'HEAD', error: c, success: f.callback })
      }
      ;(function () {
      ...
      var a = (function () {
          for (var f = '', v = 0; 32 > v; v++)
            f += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.charAt(
              Math.floor(62 * Math.random())
            )
          return f
        })(),
        t =
          'http://localhost:3000/games/netgame/AfricanKingNG/app/africanKing.1/e-background.js?r=' +
          a,
        n = 'undefined' !== typeof WEBPACK ? [] : [{ file: t, callback: e }],
        k = 0
      d('Start loading')
      c()
    }
    var m = function (c, b) {
      ...
      u = function (c) {
        ...
        nge.userFatalErrorHTML = function (b, e) {
          ...
          nge &&
            nge.observer &&
            (nge.observer.clearEventsQueue && nge.observer.clearEventsQueue(),
            nge.observer.fire('fatal.error', { title: b, description: e }))
      ...
      q = function () {
        if (nge.loadCfg[g]) {
          ...
          b +=
            '?v=' +
            (nge.Cfg && nge.Cfg.Main ? nge.Cfg.Main.version : 'cl') +
            ':' +
            (Math.floor(1000001 * Math.random()) + 0) +
            'R'
