...
})(
  {
                      ...
                      return (
                        ...
                        fetch(r + '/' + n)
                          ...
                          .then(function (e) {
                            var l = r + '/'
                            return (
                              !0 === e.preBuiltGameRulesSupported
                                ? ((l +=
                                    n.replace(/[^\/]*\.json$/, '') +
                                    'rules/templates/<gameid>.<nortp>.<language>.html'
                                      .replace(/<gameid>/g, t)
                                  ...
                                  (l =
                                    'false' === u
                                      ? l.replace(/<nortp>/g, 'nortp')
                                      : l.replace(/.<nortp>/g, '')))
                                : (l +=
                                    n.replace(/[^\/]*\.json$/, '') +
                                    'rules/rules.html?gameid=<gameid>&langid=<language>'),
                              (l = l.replace(/<gameid>/g, t).replace('<language>', a))
                            )
                          })
                      )
                    case 5:
    ...
    HDNH: [
      function (require, module, exports) {
        ...
        function t(e, t) {
          return fetch(e)
            .then(function (e) {
              return e.ok ? e.json() : fetch(t).then((e) => e.json())
            })
            .then((e) => n(e))
        }
        ;((e.readTemplate = (e, t) => {
          return fetch(`${t}/rules/templates/${e}.hbs`).then((e) => e.text())
        }),
          (e.readLanguage = (e, n) => {
            return t(`${n}/langlib/${e}/${e}.json`, `${n}/langlib/en/en.json`)
          }),
          (e.readLanguageRules = (e, n) => {
            return t(`${n}/rules/${e}/rulestext.json`, `${n}/rules/en/rulestext.json`)
          }))
        const n = (e) => {
            const t = {}
            return (
      ...
      function (require, module, exports) {
        ...
        const a = {
          generate: async (t, a, r) => {
            ...
            return Promise.all([u, d]).then((e) => ({ ...e[0], ...e[1], ...a }))
          }
        }
        var r = a
        exports.default = r
        ...
        function o(t) {
          for (var r = 1; r < arguments.length; r++)
            for (var n in arguments[r])
              Object.prototype.hasOwnProperty.call(arguments[r], n) && (t[n] = arguments[r][n])
          return t
        }
      ...
      function (require, module, exports) {
        ...
        function r(t, o) {
          ...
          n &&
            ...
            (c = n.end.column),
            (t += ' - ' + i + ':' + a))
          for (var l = Error.prototype.constructor.call(this, t), s = 0; s < e.length; s++)
            this[e[s]] = l[e[s]]
        ...
        ;((r.prototype = new Error()), (exports.default = r), (module.exports = exports.default))
      },
      {}
    ],
    Wf8o: [
      function (require, module, exports) {
        ...
        ;((exports.default = function (t) {
          t.registerHelper('blockHelperMissing', function (r, a) {
            ...
            if (e.isArray(r))
              return r.length > 0 ? (a.ids && (a.ids = [a.name]), t.helpers.each(r, a)) : i(this)
            if (a.data && a.ids) {
          ...
          t.registerHelper('each', function (t, r) {
            ...
            function c(e, r, o) {
              ;(d &&
                ...
                (d.last = !!o),
                f && (d.contextPath = f + e)),
                (u += n(t[e], { data: d, blockParams: a.blockParams([t[e], e], [f + e, null]) })))
            }
            if (
              (r.data && r.ids && (f = a.appendContextPath(r.data.contextPath, r.ids[0]) + '.'),
              a.isFunction(t) && (t = t.call(this)),
              r.data && (d = a.createFrame(r.data)),
              t && 'object' == typeof t)
            )
              if (a.isArray(t))
                for (var h = t.length; l < h; l++) l in t && c(l, l, l === t.length - 1)
              else if (e.Symbol && t[e.Symbol.iterator]) {
                for (var v = [], p = t[e.Symbol.iterator](), x = p.next(); !x.done; x = p.next())
                  v.push(x.value)
                for (h = (t = v).length; l < h; l++) c(l, l, l === t.length - 1)
              } else
                ((i = void 0),
        ...
        ;((exports.default = function (e) {
          ;(e.registerHelper('if', function (e, r) {
            ...
            return (
              ...
              (!r.hash.includeZero && !e) || t.isEmpty(e) ? r.inverse(this) : r.fn(this)
            )
          }),
        ...
        ;((exports.default = function (t) {
          t.registerHelper('with', function (t, a) {
            ...
            return (
              ...
              n(t, { data: i, blockParams: e.blockParams([t], [i && i.contextPath]) })
            )
          })
        }),
          (module.exports = exports.default))
    ...
    i17H: [
      function (require, module, exports) {
        ...
        function g(e, r, l) {
          e.helpers[r] && ((e.hooks[r] = e.helpers[r]), l || delete e.helpers[r])
        }
      },
      {
    ...
    hf4N: [
      function (require, module, exports) {
        ...
        function u(e) {
          ...
          if (!(r >= i.LAST_COMPATIBLE_COMPILER_REVISION && r <= i.COMPILER_REVISION)) {
        ...
        function c(e, r) {
          ...
          if (!e || !e.main) throw new n.default('Unknown template object: ' + typeof e)
          ;((e.main.decorator = e.main_d), r.VM.checkRevision(e.compiler))
          var t = e.compiler && 7 === e.compiler[0]
          var a = {
            strict: function (e, r, t) {
              if (!(e && r in e)) throw new n.default('"' + r + '" not defined in ' + e, { loc: t })
              return e[r]
            },
            ...
            invokePartial: function (t, a, i) {
              ;(i.hash && ((a = o.extend({}, a, i.hash)), i.ids && (i.ids[0] = !0)),
          ...
          function i(r) {
            ...
            return (
              e.useDepths &&
                (n = t.depths ? (r != t.depths[0] ? [r].concat(t.depths) : t.depths) : [r]),
          ...
          return (
            ...
            (i._setup = function (n) {
              if (n.partial)
                ...
                ;(k(i, a),
                  (a.helpers = i),
                  e.usePartial && (a.partials = a.mergeIfNeeded(n.partials, r.partials)),
            ...
            (i._child = function (r, t, o, i) {
              if (e.useBlockParams && !o) throw new n.default('must pass block params')
              if (e.useDepths && !i) throw new n.default('must pass parent depths')
        ...
        function d(e, r, t, o, a, n, i) {
          function l(r) {
            var a = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
              l = i
            return (
              !i || r == i[0] || (r === e.nullContext && null === i[0]) || (l = [r].concat(i)),
              t(e, r, e.helpers, e.partials, a.data || o, n && [a.blockParams].concat(n), l)
            )
          }
          return (
        ...
        function f(e, r, t) {
          return (
            e
              ...
              : (e = '@partial-block' === t.name ? t.data['partial-block'] : t.partials[t.name]),
            e
          )
        }
        function h(e, r, t) {
            ...
            (t.fn &&
              ...
              (function () {
                ...
                ;((l = t.data['partial-block'] =
                  ...
                  e.partials && (t.partials = o.extend({}, t.partials, e.partials)))
              })(),
            void 0 === e && l && (e = l),
            void 0 === e)
          )
            throw new n.default('The partial ' + t.name + ' could not be found')
        ...
        function v(e, r) {
          return ((r && 'root' in r) || ((r = r ? i.createFrame(r) : {}).root = e), r)
        }
              ...
              performAction: function (t, e, s, i, r, n, a) {
                ...
                switch (r) {
                  ...
                  case 10:
                    ...
                    break
                  case 11:
                    this.$ = i.prepareRawBlock(n[h - 2], n[h - 1], n[h], this._$)
                    break
                  case 12:
                    this.$ = { path: n[h - 3], params: n[h - 2], hash: n[h - 1] }
                    break
                  case 13:
                    this.$ = i.prepareBlock(n[h - 3], n[h - 2], n[h - 1], n[h], !1, this._$)
                    break
                  case 14:
                    this.$ = i.prepareBlock(n[h - 3], n[h - 2], n[h - 1], n[h], !0, this._$)
                    break
                  case 15:
                    this.$ = {
                      open: n[h - 5],
                  ...
                  case 17:
                    ...
                    break
                  case 18:
                    this.$ = { strip: i.stripFlags(n[h - 1], n[h - 1]), program: n[h] }
                    break
                  case 19:
                    var o = i.prepareBlock(n[h - 2], n[h - 1], n[h], n[h], !1, this._$),
                      l = i.prepareProgram([o], n[h - 1].loc)
                    ;((l.chained = !0), (this.$ = { strip: n[h - 2].strip, program: l, chain: !0 }))
                    break
                  case 20:
                    this.$ = n[h]
                    break
                  case 21:
                    this.$ = { path: n[h - 1], strip: i.stripFlags(n[h - 2], n[h]) }
                    break
                  case 22:
                  case 23:
                  ...
                  case 24:
                    ...
                    break
                  case 25:
                    this.$ = i.preparePartialBlock(n[h - 2], n[h - 1], n[h], this._$)
                    break
                  case 26:
                    this.$ = {
                      path: n[h - 3],
                  ...
                  case 29:
                    ...
                    break
                  case 30:
                    this.$ = { type: 'Hash', pairs: n[h], loc: i.locInfo(this._$) }
                    break
                  case 31:
                    this.$ = {
                      type: 'HashPair',
                  ...
                  case 43:
                    ...
                    break
                  case 44:
                    ;(n[h - 2].push({ part: i.id(n[h]), original: n[h], separator: n[h - 1] }),
                      (this.$ = n[h - 2]))
                    break
                  case 45:
              ...
              parse: function (t) {
                ...
                for (var u, y, _, g, m, k, b, E, f, $, N = {}; ; ) {
                  if (
                    ...
                    if (!l) {
                      for (k in ((f = []), n[_]))
                        this.terminals_[k] && k > 2 && f.push("'" + this.terminals_[k] + "'")
                      ;((x = this.lexer.showPosition
                        ...
                        : 'Parse error on line ' +
                          (h + 1) +
                          ': Unexpected ' +
                          (1 == u ? 'end of input' : "'" + (this.terminals_[u] || u) + "'")),
                        this.parseError(x, {
                  ...
                  if (g[0] instanceof Array && g.length > 1)
                    throw new Error(
                      'Parse Error: multiple actions possible at state: ' + _ + ', token: ' + u
                    )
                  switch (g[0]) {
                    case 1:
                      ;(s.push(u),
                    ...
                    case 2:
                      if (
                        ...
                        void 0 !== (m = this.performAction.call(N, a, o, h, this.yy, g[1], i, r)))
                      )
                        return m
                      ;(b &&
                        ((s = s.slice(0, -1 * b * 2)),
            ...
            n.prototype.PartialBlockStatement =
              function (e) {
                ...
                var t = e.program || e.inverse,
                  ...
                  l = o
                if (o && o.chained)
                  for (n = o.body[0].program; l.chained; ) l = l.body[l.body.length - 1].program
                var s = {
    ...
    b1zW: [
      function (require, module, exports) {
        ...
        function p(t, r) {
          return { open: '~' === t.charAt(2), close: '~' === r.charAt(r.length - 3) }
        }
        function s(t) {
        ...
        function i(t, r, o) {
          o = this.locInfo(o)
          for (var a = t ? '@' : '', n = [], p = 0, s = 0, i = r.length; s < i; s++) {
            var c = r[s].part,
              l = r[s].original !== c
            if (((a += (r[s].separator || '') + c), l || ('..' !== c && '.' !== c && 'this' !== c)))
              n.push(c)
            else {
              if (n.length > 0) throw new e.default('Invalid path: ' + a, { loc: o })
              '..' === c && p++
            }
          }
          return { type: 'PathExpression', data: t, depth: p, parts: n, original: a, loc: o }
        }
        ...
        function l(t, r, e, a) {
          o(t, e)
          var n = { type: 'Program', body: r, strip: {}, loc: (a = this.locInfo(a)) }
          return {
            type: 'BlockStatement',
            path: t.path,
            params: t.params,
        ...
        function h(t, r, a, n, p, s) {
          ...
          var c = void 0,
            l = void 0
          if (a) {
            if (i) throw new e.default('Unexpected inverse block on decorator', a)
            ;(a.chain && (a.program.body[0].closeStrip = n.strip), (l = a.strip), (c = a.program))
          }
          return (
            p && ((p = c), (c = r), (r = p)),
            {
    ...
    h3Tq: [
      function (require, module, exports) {
        ...
        ;((exports.__esModule = !0), (exports.parseWithoutProcessing = l), (exports.parse = p))
    ...
    O25j: [
      function (require, module, exports) {
        ...
        function h(e, t, i) {
          if (
            (void 0 === t && (t = {}), null == e || ('string' != typeof e && 'Program' !== e.type))
          )
            throw new s.default(
        ...
        p.prototype = {
          ...
          equals: function (e) {
            ...
            for (s = 0; s < t; s++) if (!this.children[s].equals(e.children[s])) return !1
            return !0
          },
          guid: 0,
          ...
          Program: function (e) {
            ...
            for (var t = e.body, s = t.length, o = 0; o < s; o++) this.accept(t[o])
            return (
          ...
          DecoratorBlock: function (e) {
            var t = e.program && this.compileProgram(e.program),
              ...
              o = e.path
            ;((this.useDecorators = !0), this.opcode('registerDecorator', s.length, o.original))
          },
          PartialStatement: function (e) {
            ...
            var o = e.params
            if (o.length > 1)
              throw new s.default('Unsupported number of partial arguments: ' + o.length, e)
            o.length ||
          ...
          helperSexpr: function (e, t, o) {
            var i = this.setupFullMustacheParams(e, t, o),
              a = e.path,
              p = a.parts[0]
            if (this.options.knownHelpers[p]) this.opcode('invokeKnownHelper', i.length, p)
            else {
              if (this.options.knownHelpersOnly)
                throw new s.default(
                  'You specified knownHelpersOnly, but used the unknown helper ' + p,
                  e
                )
              ;((a.strict = !0),
                (a.falsy = !0),
                this.accept(a),
                this.opcode('invokeHelper', i.length, a.original, r.default.helpers.simpleId(a)))
            }
          },
          ...
          Hash: function (e) {
            var t = e.pairs,
              s = 0,
              o = t.length
            for (this.opcode('pushHash'); s < o; s++) this.pushParam(t[s].value)
    ...
    XUQW: [
      function (require, module, exports) {
        ...
        function a(e) {
          ...
          for (
            var a, i = exports.isAbsolute(r), u = r.split(/\/+/), c = 0, s = u.length - 1;
            s >= 0;
            s--
          )
            '.' === (a = u[s])
    ...
    Wwhl: [
        ...
        ;((r.prototype._version = 3),
          ...
          (r.prototype.applySourceMap = function (e, t, r) {
            ...
            ;(this._mappings.unsortedForEach(function (o) {
              if (o.source === i && null != o.originalLine) {
                var t = e.originalPositionFor({ line: o.originalLine, column: o.originalColumn })
                null != t.source &&
                  ((o.source = t.source),
          ...
          (r.prototype._validateMapping = function (e, n, o, t) {
            ...
            if (
              ...
              throw new Error(
                'Invalid mapping: ' +
                  JSON.stringify({ generated: e, source: o, original: n, name: t })
              )
          }),
            ...
            for (
              ...
              ;((o += e.encode(t.generatedColumn - s)),
                ...
                null != t.source &&
                  ...
                  (u = t.originalColumn),
                  null != t.name &&
                    ((r = this._names.indexOf(t.name)), (o += e.encode(r - c)), (c = r))),
                (g += o))
            }
            return g
          }),
      ...
      { './base64-vlq': 'iWlY', './util': 'XUQW', './array-set': 'dghU', './mapping-list': 'AUTm' }
    ],
    rdpJ: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        function u(n, t) {
          ...
          this._sections = a.map(function (n) {
            ...
            return (
              (u = r),
              {
                generatedOffset: { generatedLine: o + 1, generatedColumn: s + 1 },
        ...
        ;((i.fromSourceMap = function (e, n) {
          ...
          (s.prototype._findMapping = function (e, r, t, o, i, s) {
            ...
            if (e[o] < 0)
              throw new TypeError('Column must be greater than or equal to 0, got ' + e[o])
          ...
          (s.prototype.originalPositionFor = function (n) {
            var r = { generatedLine: e.getArg(n, 'line'), generatedColumn: e.getArg(n, 'column') },
              t = this._findMapping(
                r,
            ...
            if (t >= 0) {
              ...
              if (o.generatedLine === r.generatedLine) {
                ...
                null !== s &&
                  ...
                  (s = e.computeSourceURL(this.sourceRoot, s, this._sourceMapURL)))
          ...
          (u.prototype.originalPositionFor = function (r) {
            var t = { generatedLine: e.getArg(r, 'line'), generatedColumn: e.getArg(r, 'column') },
          ...
          (u.prototype._parseMappings = function (n, r) {
            ...
            for (var t = 0; t < this._sections.length; t++)
              for (
                var i = this._sections[t], s = i.consumer._generatedMappings, a = 0;
                a < s.length;
                a++
              ) {
                var u = s[a],
                ...
                ;((r.code += n),
                  null !== e.source && null !== e.line && null !== e.column
                    ? ((l === e.source && u === e.line && s === e.column && c === e.name) ||
                      ...
                      (i = !0))
                    : i &&
                      (o.addMapping({ generated: { line: r.line, column: r.column } }),
                      (l = null),
                      (i = !1)))
    ...
    nPKU: [
      function (require, module, exports) {
        ...
        function i(t, e, n) {
          if (r.isArray(t)) {
            for (var i = [], s = 0, o = t.length; s < o; s++) i.push(e.wrap(t[s], n))
            return i
          }
        ...
        ;(e ||
          ...
          (s.prototype = {
            ...
            each: function (t) {
              for (var r = 0, e = this.source.length; r < e; r++) t(this.source[r])
            },
            empty: function () {
            ...
            wrap: function (t) {
              ...
              return t instanceof e
                ? t
                : ((t = i(t, this, r)), new e(r.start.line, r.start.column, this.srcFile, t))
            },
            functionCall: function (t, r, e) {
              return ((e = this.generateList(e)), this.wrap([t, r ? '.' + r + '(' : '(', e, ')']))
            },
    ...
    Be35: [
        ...
        ;((h.prototype = {
          ...
          compile: function (t, s, e, r) {
            ;((this.environment = t),
              ...
              (this.isChild = !!e),
              (this.context = e || { decorators: [], programs: [], environments: [] }),
              this.preamble(),
              (this.stackSlot = 0),
              (this.stackVars = []),
              (this.aliases = {}),
            ...
            for (h = 0, c = f.length; h < c; h++)
              f[h] && ((u[h] = f[h]), d[h] && ((u[h + '_d'] = d[h]), (u.useDecorators = !0)))
            return (
          ...
          createFunctionContext: function (t) {
            ...
            ;(Object.keys(this.aliases).forEach(function (t) {
              ...
              i.children &&
                i.referenceCount > 1 &&
                ((e += ', alias' + ++r + '=' + t), (i.children[0] = 'alias' + r))
            }),
          ...
          mergeSource: function (t) {
            ...
            return (
              this.source.each(function (t) {
                t.appendToBuffer
                  ? (n ? t.prepend('  + ') : (n = t), (a = t))
                  : (n && (r ? n.prepend('buffer += ') : (i = !0), a.add(';'), (n = a = void 0)),
                    (r = !0),
                    s || (e = !1))
              }),
              e
          ...
          blockValue: function (t) {
            ...
            var i = this.popStack()
            ;(e.splice(1, 0, i), this.push(this.source.functionCall(s, 'call', e)))
          },
          ...
          registerDecorator: function (t, s) {
            ...
            this.decorators.push([
              'fn = ',
              this.decorators.functionCall(e, '', ['fn', 'props', 'container', i]),
              ' || fn;'
            ])
          },
          invokeHelper: function (t, s, e) {
            ...
            ;(e && n.push(r.name),
              n.push(i),
              this.options.strict || n.push(this.aliasable('container.hooks.helperMissing')))
          ...
          invokePartial: function (t, s, e) {
            ...
            ;(t && ((s = this.popStack()), delete r.name),
              ...
              t ? i.unshift(s) : i.unshift(this.nameLookup('partials', s, 'partial')),
          ...
          compileChildren: function (t, s) {
            for (var e = t.children, i = void 0, r = void 0, n = 0, a = e.length; n < a; n++) {
              ...
              if (null == o) {
                ...
                ;((i.index = h),
                  (i.name = 'program' + h),
                  (this.context.programs[h] = r.compile(i, s, this.context, !this.precompile)),
          ...
          replaceStack: function (t) {
            ...
            var c = t.call(this, e)
            ;(n || this.popStack(), r && this.stackSlot--, this.push(s.concat(c, ')')))
          },
          incrStack: function () {
            return (
              this.stackSlot++,
          ...
          setupParams: function (t, s, e) {
            ...
            ;(o && (e = []),
              ...
              this.stringParams &&
                ((i.hashTypes = this.popStack()), (i.hashContexts = this.popStack())))
            var c = this.popStack(),
              p = this.popStack()
            ...
            for (var u = s; u--; )
              ((h = this.popStack()),
                ...
                this.stringParams && ((n[u] = this.popStack()), (r[u] = this.popStack())))
            return (
          ...
          setupHelperArgs: function (t, s, e, i) {
            ...
            return (
              ...
              (r = this.objectLiteral(r)),
              i
                ? (this.useRegister('options'), e.push('options'), ['options=', r])
                : e
                  ? (e.push(r), '')
                  : r
            )
      ...
      { '../base': 'd7Tx', '../exception': 'Whac', '../utils': 'cXff', './code-gen': 'nPKU' }
    ],
    WNU3: [
      function (require, module, exports) {
        'use strict'
    ...
    pkZH: [
      function (require, module, exports) {
        ...
        ;((exports.__esModule = !0), (exports.print = e), (exports.PrintVisitor = i))
        ...
        ;((i.prototype = new a.default()),
          ...
          (i.prototype.Program = function (t) {
            ...
            if (t.blockParams) {
              var n = 'BLOCK PARAMS: ['
              for (e = 0, i = t.blockParams.length; e < i; e++) n += ' ' + t.blockParams[e]
              ;((n += ' ]'), (r += this.pad(n)))
            }
          ...
          (i.prototype.BlockStatement = i.prototype.DecoratorBlock =
            function (t) {
              var r = ''
              return (
                (r += this.pad(('DecoratorBlock' === t.type ? 'DIRECTIVE ' : '') + 'BLOCK:')),
                this.padding++,
          ...
          (i.prototype.Hash = function (t) {
            for (var r = t.pairs, a = [], e = 0, i = r.length; e < i; e++) a.push(this.accept(r[e]))
            return 'HASH{' + a.join(', ') + '}'
          }),
      ...
      function (require, module, exports) {
        ...
        ;((e.PrintVisitor = r.PrintVisitor),
          ...
          'undefined' != typeof require &&
            require.extensions &&
            ((require.extensions['.handlebars'] = i), (require.extensions['.hbs'] = i)))
      },
      {
    ...
    mGne: [
      function (require, module, exports) {
        ...
        ;(e.default.registerHelper({
          ...
          (t.resolve = (r, t, o = { noEscape: !0, strict: !0 }) => e.default.compile(t, o)(r)),
      ...
      function (require, module, exports) {
        ...
        !(function (t) {
          ...
          var a,
            ...
            n,
            s =
              ((a = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZWN]|"[^"]*"|'[^']*'/g),
              (m =
              ...
              function (e, t, r, y) {
                      ...
                      (null === (d = e)
                        ...
                        : void 0 === d
                          ...
                          : 'object' != typeof d
                            ...
                            : Array.isArray(d)
                              ? 'array'
                              : {}.toString.call(d).slice(8, -1).toLowerCase()) ||
                    /\d/.test(e) ||
                    ((t = e), (e = void 0)),
                ...
                var d,
                  o = (t = String(s.masks[t] || t || s.masks.default)).slice(0, 4)
                ;('UTC:' !== o && 'GMT:' !== o) ||
                  ((t = t.slice(4)), (r = !0), 'GMT:' === o && (y = !0))
                var u = r ? 'getUTC' : 'get',
                  l = e[u + 'Date'](),
                  M = e[u + 'Day'](),
                  T = e[u + 'Month'](),
                  ...
                  p = (function (e) {
                    ...
                    var m = t.getTimezoneOffset() - a.getTimezoneOffset()
                  ...
                  S = {
                    ...
                    l: i(D, 3),
                    L: i(Math.round(D / 10)),
                    t: c < 12 ? s.i18n.timeNames[0] : s.i18n.timeNames[1],
                    tt: c < 12 ? s.i18n.timeNames[2] : s.i18n.timeNames[3],
                    T: c < 12 ? s.i18n.timeNames[4] : s.i18n.timeNames[5],
                    TT: c < 12 ? s.i18n.timeNames[6] : s.i18n.timeNames[7],
                    Z: y ? 'GMT' : r ? 'UTC' : (String(e).match(m) || ['']).pop().replace(n, ''),
                    o:
                      (N > 0 ? '-' : '+') +
                      i(100 * Math.floor(Math.abs(N) / 60) + (Math.abs(N) % 60), 4),
                    S: ['th', 'st', 'nd', 'rd'][
    ...
    sPhZ: [
      function (require, module, exports) {
          ...
          return (
            (
              await fetch(`${s}/META-INF/MANIFEST.MF`)
                .then((t) => t.text())
                .catch((t) => {
                  throw new Error('Can not fetch the MANIFEST.MF')
                })
            )
              .split(/\r?\n/g)
              .forEach((e) => {
        ...
        r.beautify = async (t, e = '') => {
          let r = `<div class="grc">\n${(t = '<meta http-equiv="content-type" content="text/html;charset=UTF-8" />\n' + (t = `<link rel="stylesheet" href="${e || '..'}/rules/css/generic.css" type="text/css" />` + '\n' + t))}\n${`<div id="manifest_timestamp" style="margin-top:10px;">${await s(e)}</div>`}</div>`
          return (e && (r = r.replace(/src="..\//g, 'src="' + e + '/')), r)
        }
        var n = r
        exports.default = n
      },
      ...
      function (require, module, exports) {
        ...
        const l = {
          canRenderRuntime: async (e, t) => {
            ...
            return await fetch(`${t}/rules/templates/${a}.hbs`).then((e) => 404 !== e.status)
          },
          ...
          renderAllowMissingKeys: (e, r) => t.default.skipIfsResolve(e, r)
        }
        var f = l
        exports.default = f
      },
    ...
    JWvI: [
      function (require, module, exports) {
        ...
        var r = (function () {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (r = t.replace('_sw', '')),
                          (u = ''.concat(n, '/rules/templates_config.json')),
                          (e.next = 4),
                          fetch(u)
                            .then(function (e) {
                              return 404 !== e.status ? e.json() : Promise.reject('File not found')
                            })
                            .then(function (e) {
                              return e[r]
                            })
                      ...
                      case 4:
                        return ((a = e.sent), e.abrupt('return', a ? a.values : {}))
                      case 6:
                      case 'end':
                        return e.stop()
                    }
          ...
          a = (function () {
            var e = t(
              regeneratorRuntime.mark(function e(t, n, r, u) {
                var a
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (a = ''
                            .concat(t, '/servlet/CasinoGameServlet;jsession=')
                            .concat(r, '?action=init&gameId=')
                            .concat(n, '&sessid=')
                            .concat(r)),
                          (a += u ? '&jurisdictionCode='.concat(u) : ''),
                          (e.next = 4),
                    ...
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          ...
                          (i = u.gameLocation),
                          (a.next = 3),
                          r.default.fetch(o, i).then(function (r) {
                            var a = Object.assign({}, c)
                            return (
                              r[n.BETTING_MODES]
                                ? (r[n.BETTING_MODES_LEGACY] = r[n.BETTING_MODES])
                                : r[n.BETTING_MODES_LEGACY] &&
                                  (r[n.BETTING_MODES] = r[n.BETTING_MODES_LEGACY]),
                              'true' === r.g4mode && (a[n.QUICK_SPIN_AVAILABLE] = 'false'),
                              e.default.render(o.gameId, o.lang, (0, t.manageData)(a, r, o), i)
                            )
                          })
                        )
                      case 3:
                ...
                return regeneratorRuntime.wrap(function (r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return ((r.next = 2), e.default.canRenderRuntime(t, n))
                      case 2:
                  ...
                  switch ((n.prev = n.next)) {
                    case 0:
                      for (i in (a['bettingModes.0'] &&
                        ((u = a['bettingModes.1']
                          ? [a['bettingModes.0'], a['bettingModes.1']].join()
                          : a['bettingModes.0']),
                        (a[t.BETTING_MODES] = u),
                        (a[t.BETTING_MODES_LEGACY] = u)),
                      void 0 !== a.maxBet && (a[t.MAX_BET] = a.maxBet),
                      a))
                        a.hasOwnProperty(i) && (a[i] = a[i] ? a[i].toString() : '')
                      if (
                        (a.staticServer ||
                          ((f = window.location.href),
                          (d = f.lastIndexOf('/games/')),
                          (a.staticServer = f.substring(0, d))),
                        !((l = c(a)).length > 0))
                      ) {
                        n.next = 7
                        break
                      ...
                      return n.abrupt(
                        'return',
                        Promise.reject(l + ' field missing in the input:' + JSON.stringify(a))
                      )
                    case 7:
                      return ((n.next = 9), o(a.gameId, a.casinoBrand, a.staticServer))
                    case 9:
                      return (
                        (p = n.sent),
                        (g = s(p, a.staticServer)),
                        (n.next = 13),
                        r.default.canRenderRuntime(a.gameId, g)
                      )
                    case 13:
                      if (!n.sent) {
                        n.next = 20
                      ...
                      return (
                        (n.next = 17),
                        r.default.renderRules({ queryData: a, gameLocation: g }).then(function (e) {
                          return { flow: 'modern', content: e }
                        })
                      )
                    case 17:
                    ...
                    case 20:
                      return (
                        (n.next = 22),
                        e.default
                          .renderRules(a.staticServer, p, a.gameId, a.lang, a.showRtp)
                          .then(function (e) {
                            return { flow: 'legacy', content: e }
                          })
                      )
                    case 22:
                      return n.abrupt('return', n.sent)
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (a = r.replace('_sw', '')),
                          (e.next = 3),
                          fetch(''.concat(n, '/gameinclusion/directory/directory.json'))
                            .then(function (e) {
                              return e.json()
                            })
                            .then(function (e) {
                            ...
                            .then(function (e) {
                              return t && 'default' !== t
                                ? e.replace('<casinobrand>', t)
                                : e.replace('<casinobrand>/', '')
                            })
                        )
                      case 3:
                        return e.abrupt('return', e.sent)
    ...
    XbLW: [
      function (require, module, exports) {
        ...
        var o = (function () {
                      ...
                      case 0:
                        return (
                          ...
                          (v = t.queryData) ||
                            ...
                            (v[r.BETTING_MODES_LEGACY] = f)),
                          (l = Object.assign({}, v)),
                          n.abrupt('return', e.default.render(l))
                        )
                      case 4:
                      case 'end':
                        return n.stop()
          ...
          u = function () {
            for (var e = 'DEMO-', r = 0; r < 17; r++) e += Math.floor(10 * Math.random())
            return e + '-EUR'
          }
      ...
      { 'regenerator-runtime/runtime': 'QVnC', './renderer': 'b7LN', './constants': 'iJA9' }
    ]
  },
  {},
  ['XbLW'],
