...
;((window.Sys = {}),
  (function () {
    ...
    ;((Sys.openBetMode = !1),
      ...
      (Sys.isGcmEnabled = !1),
      /openbet.gcmMode=true/i.test(window.location.search) && (Sys.isGcmEnabled = !0),
      (Sys.isiPad = !1),
      (Sys.isiPhone = !1),
      (Sys.isiPhoneIOS7 = !1),
      (Sys.isiPhoneIOS8 = !1),
      ...
      n.match(/Chrome/i) &&
        ((Sys.isChrome = !0), n.match(/Chrome\/28[\.\d]/i) && (Sys.isChrome280 = !0)),
        ...
        : n.match(/iPod/i)
          ...
          : n.match(/iPhone/i)
            ? ((e = '3gs,4,4s'),
              ...
              (t =
                window.matchMedia('(-webkit-min-device-pixel-ratio: 3)').matches && '6' === e
                  ? 'zoomed'
                  : t),
            ...
            : n.match(/Android/i) || n.match(/HTC_Sensation/i)
              ? ((Sys.isAndroidDevice = !0),
                n.match(/Android 3[\.\d]+/i)
                  ? ((Sys.isAndroid3Tablet = !0), (Sys.isAndroidTablet = !0))
                  : n.match(/mobile/i)
      ...
      (Sys.isiPhoneIOS7 =
        ...
        Sys.isSafari),
      (Sys.isiPhoneIOS8 =
        /OS\s*8_/i.test(n) && !window.navigator.standalone && Sys.isiPhone && Sys.isSafari),
      (Sys.isiPhoneIOS9 =
        /OS\s*9_/i.test(n) && !window.navigator.standalone && Sys.isiPhone && Sys.isSafari),
      ...
      (Sys.isIphone5Or5sOr5c =
        Sys.isiPhone && 320 === window.screen.width && 568 === window.screen.height),
      n.match(/GT-I9100/)
        ? (Sys.isSamsungS = {
            series: 'samsungS',
            model: 's2'
  ...
  (Sys.applyPropertiesIf = function (e, t) {
    var n,
      ...
      s = o.length
    for (n = -1; ++n < s; )
      ((i = o[n]), !Sys.isDefined(e[i]) && Sys.isDefined(t[i]) && (e[i] = t[i]))
    return e
  }),
  ...
  (Sys.range = function (e, t, n) {
    var i,
      ...
      s = [e],
      r = e > t
    for (i = r ? -1 * Math.abs(n) || -1 : Math.abs(n) || 1, o = e + i; r ? o >= t : o <= t; )
      (s.push(o), (o += i))
    return s
  }),
  (Sys.reduce = function (e, t, n) {
    ...
    for (Sys.isDefined(n) || ((n = e[0]), (e = e.slice(1))), i = 0, o = e.length; i < o; i++)
      n = t(n, e[i], i, e)
    return n
  }),
  ...
  (Sys.EventHandler.prototype = {
    ...
    toStringHistory: function (e) {
      ...
      return (
        Sys.each(n.history, function (e) {
          ...
          o.test(e.event) && (i += e.event + ' (' + e.listeners + ') -> ' + t + '\r\n')
        }),
        i
      )
    },
    ...
    dispatchEvent: Sys.variadic(function (e, t) {
      var n,
        ...
        r = s.length - 1
      for (n = r; n >= 0; n--)
        ((i = s[n]), (o = Sys.isObj(i) ? i.handlers[e] : null) && o.apply(i, t))
    ...
    sortEventListeners: function (e) {
      var t,
        ...
        r = s.length
      for (i = -1; ++i < r; )
        ((t = o[s[i]]), (n = t.indexOf(e)) > 0 && (t.splice(n, 1), t.unshift(e)))
    }
  }),
  ...
  (Sys.Observable = function (e) {
    ;((this.eventHandler =
      Sys.isDefined(e) && Sys.isDefined(e.eventHandler) ? e.eventHandler : EventHandler),
      (this.handlers = {}))
  }),
  (Sys.Observable.prototype = {
    ...
    on: function (e) {
      for (var t, n = this, i = Object.keys(e), o = i.length, s = 0; s < o; )
        ((t = i[s]), n.addListener(t, e[t]), ++s)
    },
    off: function () {
      for (var e, t = this, n = Object.keys(t.handlers), i = n.length, o = 0; o < i; )
                        ...
                        : 'textContent' === t
                          ...
                          : 'onClick' === t
                            ...
                            : 'items' === t
                              ...
                              : 'transitionend' === t && 'function' == typeof n
                                ? (this.transitionEnd = n)
                                : 'renderTo' !== t && 'tag' !== t && this.el.setAttribute(t, n)
                  }, this)),
            this.el)
          : null
      )
      ...
      ;(Sys.Element.superclass.removeListener.apply(this, arguments),
        this.DOMEvents[e].forEach(function (n, o) {
          return (
            ...
            n.func === t &&
            n.scope === i &&
            (this.DOMEvents[e].splice(o, 1), this.el.removeEventListener(e, n.wrappedFn, !1), !0)
          )
        }, this))
    },
    getOffset: function () {
  ...
  (Sys.Deferred.prototype = {
    when: function (e) {
      var t
      return (
        (t = Sys.isArray(e) ? e : Array.prototype.slice.call(arguments, 0)),
        Sys.each(
          t,
          function (e) {
    ...
    onStateUpdated: function () {
      ...
      for (
        this.state === this.states.resolved
          ...
          : this.state === this.states.rejected && (i = this.failList.concat(this.alwaysList)),
          n = i.length,
          t = -1;
        ++t < n;
  ...
  (function () {
    var e = {
      ...
      httpGet: function (e) {
        ...
        return i
          ? ((t.onreadystatechange = function () {
              4 === this.readyState &&
                ((t.onreadystatechange = function () {}),
                Sys.utils.httpRequestIsOK(t)
                  ? 'arraybuffer' !== e.responseType && Sys.isDefined(Sys.utils.getErrorCode(t))
                    ? n.rejectWith([t])
                    : n.resolveWith([t])
                  : n.rejectWith([t]))
            }),
            Sys.isDefined(e.onProgressCallback) &&
              (t.onprogress = function (t) {
                e.onProgressCallback(t, e.name)
              }),
            t.open(mt, i),
            Sys.isDefined(e.responseType) && (t.responseType = e.responseType),
            Sys.isEmpty(e.useCredentials) || (t.withCredentials = e.useCredentials),
            t.send(),
            n)
          : (n.resolveWith([null]), n)
      },
            ...
            ;(o.push(document.createTextNode(u.slice(s, a))),
              ...
              (n = function () {
                ...
                return 'string' == typeof e || Sys.isNumber(e)
                  ? (o.push(document.createTextNode(e.toString())), e)
                  : (Sys.isObj(e) && o.push(e.getEl()), '')
              }),
              n.apply(i, arguments))
          }),
          s < e.length && o.push(document.createTextNode(e.slice(s, e.length))),
          o
        )
      },
      ...
      getTransformationOffset: function (e) {
        ...
        if (e.parentElement)
          do {
            ;((t = new WebKitCSSMatrix(window.getComputedStyle(e).webkitTransform)),
              (n += t.e),
              (i += t.f))
      ...
      getKeys: function (e) {
        var t,
          n = [],
          i = e.keys
        if ('function' != typeof i) for (t in e) e.hasOwnProperty(t) && n.push(t)
        else n = i(e)
        return n
      },
      ...
      parseQueryString: function (e, t) {
        ...
        for (n = 0; n < l.length; n++) {
          for (i = l[n].split('='), o = i[0].split('.'), r = c, s = 0; s < o.length - 1; s++)
            (r[o[s]] || (r[o[s]] = {}), (r = r[o[s]]))
          ;((a = o[o.length - 1]),
            (u = !0 === t ? this.parseValue(decodeURIComponent(i[1])) : decodeURIComponent(i[1])),
            '' !== a && (r[a] = u))
        }
        return c
      },
      parseValue: function (e) {
        ...
        if ('undefined' !== e.toLowerCase()) {
          ...
          return e.split(':').length > 1
            ? ((t = e.split(':')), (i[t[0]] = this.parseValue(t[1])), i)
            : e
        }
      },
      parseReelInfo: function (e, t) {
        ...
        for (
          ...
          ((o = {
            ...
            n['i' + i].overlay && (o.overlaySymbols = this.getOverlaySymbols(n['i' + i].overlay)),
            s.push(o))
        return s
      },
      ...
      goToLobby: function (e) {
        ...
        t
          ? Utils.Platform.inIframe() && '#' === t
            ? window.parent.postMessage(['event', 'goToLobby', e], '*')
            : this.setWindowLocation(this.processLobbyUrl(t, e))
          : console.warn('Environment#goToLobby - lobbyURL can not be resolved.')
      },
      isHomeAvailable: function () {
        var e = Resources.readData('lobbyUrl')
        return (
          void 0 !== e && 'undefined' !== e && '' !== e && null !== e && !Platform.isDesktopDevice
        )
      },
      processLobbyUrl: function (e, t) {
        var n,
          ...
          r = ''
        return (
          s.test(e) ? ((r = s.exec(e)[0]), (n = e.replace(s, ''))) : (n = e),
          void 0 !== t && (n = Sys.utils.appendParameterToQuery(n, 'reason=' + t)),
          i &&
            (i.gameId && (n = Sys.utils.appendParameterToQuery(n, 'gameId=' + i.gameId)),
            o && (n = Sys.utils.appendParameterToQuery(n, 'sessId=' + o))),
          (n += r)
        )
      },
      ...
      getMoneyConfig: function (e, t) {
        ...
        return (
          ...
          (o.MONEY_TYPES = n ? this.fetchBettingMode(n, 'cash,coins') : 'cash,coins'),
      ...
      fetchBettingMode: function (e, t) {
        return (
          (e = 'string' == typeof e ? e.replace(/ /g, '').toLowerCase() : t),
          'cash' === e || 'coins' === e ? e : t
        )
      },
      fetchDefaultBettingMode: function (e, t) {
        return (
          (e = 'string' == typeof e ? e.replace(/ /g, '').toLowerCase() : 'cash'),
    ...
    init: function (e) {
      ...
      ;(Sys.each(o, function (t) {
        if (e[t]) s[t] = e[t]
          ...
          throw new Error(
            'Module :: The ' + e.name + ' module has a ' + t + ' class defined that is not included'
          )
      }),
        s.model &&
          ((t = s.model),
  ...
  (function (e) {
    ...
    !e.AudioContext &&
      ...
      t.prototype.createGain ||
        ((AudioContext.prototype._createGain = t.prototype.createGainNode),
        (AudioContext.prototype.createGain = function () {
          var e = this._createGain()
          return (n(e.gain), e)
        })),
      t.prototype.createDelay ||
        ((AudioContext.prototype._createDelay = t.prototype.createDelayNode),
        (AudioContext.prototype.createDelay = function () {
          var e = this._createDelay()
          return (n(e.delayTime), e)
        })),
      (AudioContext.prototype.createScriptProcessor =
        t.prototype.createScriptProcessor || t.prototype.createJavascriptNode),
      (AudioContext.prototype._createOscillator = t.prototype.createOscillator),
      (AudioContext.prototype.createOscillator = function () {
        var e = this._createOscillator()
        return (e.start || (e.start = e.noteOn), e.stop || (e.stop = e.noteOff), e)
      }),
      (AudioContext.prototype._createBufferSource = t.prototype.createBufferSource),
  ...
  (Utils.Platform = {
    ...
    init: function () {
      ...
      ;(window.addEventListener(
        ...
        function () {
          var e,
            n = (screen.orientation || {}).type || screen.mozOrientation || screen.msOrientation,
            i = null,
            o = 0,
            s = function (e) {
              ;(t.DEBUG && console.info('Orientation changed to:', e),
                EventHandler.dispatchEvent('notify:platform.orientationChanged', e))
            },
            r = function (n) {
              ;(i || (i = n),
                ...
                o < 150
                  ...
                  : ((e = t.getOrientation()), s(e), (i = null)))
            }
          ;(t.DEBUG && console.info('Screen orientation:', n),
            void 0 !== n ? ((e = t.getOrientation(n)), s(e)) : window.requestAnimationFrame(r))
        },
        !1
      ),
        window.addEventListener(
        ...
        (e = this.getPageVisibilityAPI()) &&
          document.addEventListener(
            ...
            function () {
              ...
              ;(t.DEBUG && console.info('Page visibility changed to:', n),
                EventHandler.dispatchEvent('notify:platform.visibilityChanged', n),
                EventHandler.dispatchEvent('pageVisibilityChanged_event', n))
            },
            !1
          ))
    },
    ...
    is3DTransformSupported: function () {
      var e = document.createElement('p'),
        t = ['-webkit-transform', '-o-transform', '-ms-transform', '-moz-transform', 'transform'],
        n = !1
      return (
  ...
  (Utils.Helpers = {
    ...
    logData: function (e, t, n) {
      if (window.netent_gcc && window.netent_gcc.Api && window.netent_gcc.Api.logData)
        try {
  ...
  (Sys.Environment = {
    ...
    onResized: function () {
      document.documentElement.style.fontSize =
        parseInt(100 * this.determineResolution().resolution.pixelFactor, 10) + 'px'
    },
    ...
    updateResolutionProperties: function () {
      ;((this.resolutionProperties = this.determineResolution()),
        (document.documentElement.style.fontSize =
          100 * this.resolutionProperties.resolution.pixelFactor + 'px'))
    },
    ...
    identifyOS: function () {
      ...
      ;(e.match(/Windows/i)
        ...
        : e.match(/Android/i)
          ? (t = 'android')
          : (e.match(/iPad/i) || e.match(/iPhone/i) || e.match(/iPod/i)) && (t = 'ios'),
        (this.os = t))
    },
    ...
    identifyPlatform: function () {
      var e = 'mobile'
      ;(Platform.isTabletDevice ? (e = 'tablet') : Platform.isDesktopDevice && (e = 'desktop'),
        (this.platformCSS = e),
    ...
    getOrientation: function () {
      return Sys.isDefined(this.deviceOrientation)
        ...
        : Platform.isDesktopDevice || (!this.allowsCustomCanvasSize() && Platform.isTabletDevice)
          ? 'LANDSCAPE'
    ...
    getKeyOfClosestResolution: function (e, t) {
      for (var n, i = t[0].value, o = t[0].key, s = Math.abs(e - i), r = t.length; r--; )
    ...
    getClosestResolution: function (e, t) {
      ...
      return null === n || 0 === Object.keys(n).length
        ? (console.warn('No resolutions found. Check the documentation.'), null)
    ...
    getPlatformSpecificConfig: function (e, t) {
      var n = this.getCurrentPlatform(),
        ...
        o = 'default'
      return (
        t && ((n = n.toUpperCase()), (i = i.toUpperCase()), (o = o.toUpperCase())),
    ...
    getOrientationSpecificConfig: function (e, t) {
      ...
      return Sys.isDefined(e) && null !== e
        ? (t
          ...
          Sys.isDefined(e[o])
            ? ((s = Sys.applyProperties(s, e[o])), (s = Sys.applyProperties(s, e[n] || {})))
            : e[n] || e[i] || null)
        : null
    },
    ...
    getVirtualResolution: function (e) {
      ...
      return null !== t
        ? t
        : (console.error('No default virtual resolution provided. Please check documentation.'),
          null)
    },
    ...
    getRealScreenSize: function () {
      ...
      return Platform.isDesktopDevice
        ...
        : ('PORTRAIT' === this.getDeviceOrientation()
            ? ((e = Math.min(window.screen.width, window.screen.height)),
              (t = Math.max(window.screen.width, window.screen.height)))
            : 'LANDSCAPE' === this.getDeviceOrientation() &&
              ((e = Math.max(window.screen.width, window.screen.height)),
              (t = Math.min(window.screen.width, window.screen.height))),
          {
            width: e,
            height: t
          })
    ...
    isStartEvent: function (e) {
      ...
      return ('mousedown' !== e.type || t.leftButtonClicked(e) || (n = !1), n)
    },
    isEndEvent: function (e) {
      var t = this,
        n = Sys.contains(t.interactionEvents.end, e.type)
      return ('mouseup' !== e.type || t.leftButtonClicked(e) || (n = !1), n)
    },
    ...
    defineInputEvents: function () {
      ...
      ;(window.navigator.pointerEnabled || window.navigator.msPointerEnabled
        ? (t.push(window.navigator.pointerEnabled ? 'pointerdown' : 'MSPointerDown'),
          n.push(window.navigator.pointerEnabled ? 'pointermove' : 'MSPointerMove'),
          i.push(window.navigator.pointerEnabled ? 'pointerup' : 'MSPointerUp'),
          o.push(window.navigator.pointerEnabled ? 'pointerout' : 'MSPointerOut'),
          Utils.Platform.isTouchSupported() || s.push(e.getMouseWheelEventName()),
          u.push('pointerEvent'))
        : (Utils.Platform.isTouchSupported() &&
          ...
          Platform.isAndroidStockBrowser ||
            ...
            u.push('mouseEvent'))),
        'desktop' === e.platform && (r.push('keyup'), a.push('keydown')),
        (e.interactionEvents = {
          start: t,
          move: n,
          end: i,
  ...
  (Sys.UserInputUtils = {
    ...
    isUserInputInSegment: function (e, t, n) {
      ...
      for (
        Sys.isArray(c) || (c = [c]),
          l = !Sys.isDefined(l) || l,
          o = l ? Environment.determineResolution().windowToVirtualScale : 1,
          s = e.x * o,
          r = e.y * o,
          u = -1,
          i = c.length;
        ...
        if (((a = c[u]), s >= a.x && s <= a.x + a.width && r >= a.y && r <= a.y + a.height))
          return !0
      return !1
    }
  }),
    ...
    preload: function (e) {
      ...
      ;('languageJSON' !== e && 'languageXML' !== e) ||
        ...
        'languageJSON' === e
          ...
          : 'languageXML' === e && (this.texts = this.loadLanguageXML(t)),
    ...
    return (
      (e = function (e, t, n) {
        var i,
          o = new RegExp(t),
          s = o.exec(e)
        if (!(s && s.length > 0)) throw new Error('Could not find a matching version')
        if (
          ((i = s[1]),
      ...
      (t = function (t, n, i) {
        ...
        for (l = 0; l < h; l++)
          if (
            ...
            s.excludePattern && (a = new RegExp(s.excludePattern).test(t)),
            r.test(t) && !a)
          )
            return (
              o.version
                ? ((u = e(t, s.version.matchPattern, s.version.separator)),
                  (c = Core._DeviceDetectionUtils.isInRange(u, o.version.min, o.version.max)))
                : (c = !0),
              {
                name: d[l],
                inRange: c
      ...
      (n = function (e, n) {
        var i,
          ...
          u = {}
        if (a) {
          if (((u.allowed = !0), (u.preferredBrowser = s[a.name].preferredBrowser), !a.inRange))
            return ((u.code = Core.DeviceDetectionCodes.GREY_OS_VERSION), u)
          ;((o = r[a.name].browsers),
            ...
            o
              ? i
                ? i.inRange
                  ...
                  : (u.code = Core.DeviceDetectionCodes.GREY_BROWSER_VERSION)
                : (u.code = Core.DeviceDetectionCodes.GREY_BROWSER)
              : (u.code = Core.DeviceDetectionCodes.WHITE))
        }
        return u
      }),
          ...
          c &&
            ...
            s && s.inRange
              ? ((r = o[s.name]),
                ...
                (l.allowed = !1),
                r.version
                  ? (l.code = Core.DeviceDetectionCodes.BLACK_BROWSER_VERSION)
                  : (l.code = Core.DeviceDetectionCodes.BLACK_BROWSER))
              : i.version
                ? o || ((l.allowed = !1), (l.code = Core.DeviceDetectionCodes.BLACK_OS_VERSION))
                : ((l.allowed = !1), (l.code = Core.DeviceDetectionCodes.BLACK_OS))),
          l
        )
      }),
      (o = function (e, t) {
  ...
  (Core._DeviceDetectionUtils = (function () {
    return {
      ...
      compareVersions: function (e, t) {
        ...
        for (
          s = e.split('.').map(parseFloat), r = t.split('.').map(parseFloat);
          s.length < r.length;

        )
          s.push(0)
        for (; r.length < s.length; ) r.push(0)
        for (n = 0; n < s.length; n++) if (((i = s[n]), (o = r[n]), i !== o)) return i < o ? -1 : 1
        return 0
      },
      isInRange: function (e, t, n) {
        var i = !0,
          o = !0
        return (
          t && Core._DeviceDetectionUtils.compareVersions(e, t) < 0 && (i = !1),
          n && Core._DeviceDetectionUtils.compareVersions(e, n) > 0 && (o = !1),
          i && o
        )
      }
    }
  ...
  (Sys.utils.XMLHelper = {
    getNodeValue: function (e, t) {
      var n
      return t.getElementsByTagName && ((n = t.getElementsByTagName(e)), n.length > 0)
        ? n[0].textContent
        : null
    },
    findNode: function (e, t) {
      var n
      return t.getElementsByTagName && ((n = t.getElementsByTagName(e)), n.length > 0) ? n[0] : null
    },
    ...
    toJSON: function (e) {
      ...
      if (e.hasChildNodes())
        for (s.children = [], i = 0, o = e.childNodes.length; i < o; i++)
          ((t = e.childNodes.item(i)),
            1 === t.nodeType
              ? s.children.push(this.toJSON(t))
              : 3 === t.nodeType && (s.text = t.nodeValue.replace(/^\s+|\s+$/g, '')))
      if (e.attributes)
        for (s.attributes = {}, i = 0, o = e.attributes.length; i < o; i++)
          ((n = e.attributes[i]), (s.attributes[n.nodeName] = n.nodeValue))
...
;(Sys.ns('Platform'),
  (Platform.PlatformManager = {
      ...
      ;((Platform.isWindowsMobileDevice = !1),
        ...
        /Windows Phone/i.test(i)
          ...
          : /\sarm;/.test(i) &&
            ...
            (Platform.isWindowsHandHeldDevice = !0),
            (navigator.msMaxTouchPoints > 0 && window.MouseEvent) || /touch; wpdesktop/.test(i)
              ? (Platform.isTabletDevice = !1)
        ...
        /ipod|ipad|iphone/i.test(i) &&
          ...
          /ipad/i.test(i) ? (Platform.isTabletDevice = !0) : (Platform.isMobileDevice = !0),
          /iPhone\sOS\s13/i.test(i) && (Platform.isIOS13Device = !0),
          /iPhone\sOS\s14/i.test(i) && (Platform.isIOS14Device = !0),
          !0 === window.navigator.standalone && (Platform.isStandalone = !0),
          (Platform.iPhoneWithHomeIndicator = (function () {
            var e = window.devicePixelRatio || 1,
              ...
              o = function (e, o) {
                return (i.width === e && i.height === o) || (i.width === o && i.height === e)
              },
              t = o(1125, 2436),
              r = o(1125, 2436),
              s = o(1242, 2688),
        ...
        /Android/i.test(i) &&
          ...
          /mobile/i.test(i) ? (Platform.isMobileDevice = !0) : (Platform.isTabletDevice = !0),
          /Chrome/i.test(i)
          ...
          /GT-I9505|GT-I9521|GT-I9525/i.test(i) && (Platform.isSamsungS4Device = !0)),
        Platform.isMobileDevice || Platform.isTabletDevice || (Platform.isDesktopDevice = !0),
        (Platform.isIEBrowser = /trident/i.test(i)),
        (Platform.isEdgeBrowser = /edge/i.test(i)),
        (Platform.isSafariBrowser = /Safari/i.test(i) && !/Chrome/i.test(i) && !/CriOS/i.test(i)),
        (Platform.isChromeForIOS = /CriOS/i.test(i)),
        (!Platform.isDesktopDevice ||
          (Platform.isDesktopDevice && Sys.isDefined(window.orientation))) &&
    ...
    checkIfLowEndDevice: function (e) {
      ...
      return (
        (Platform.isAndroidStockBrowser ||
          ...
          Sys.isIphone3GS ||
          (Sys.isiPad && !window.matchMedia('(-webkit-min-device-pixel-ratio: 2)').matches) ||
          (Platform.isWindowsHandHeldDevice && this.isLowMemoryWinPhone(e)) ||
    ...
    isLowMemoryWinPhone: function (e) {
      var i,
        o = []
      return !!(/Lumia/i.test(e) && ((i = e.match(/[L|l]umia (\d+)/i)), o.indexOf(i[1]) > -1))
    },
    isWebGLSupported: function () {
      var e,
        i,
      ...
      try {
        return (
          ...
          (i = e.getContext('webgl', o) || e.getContext('experimental-webgl', o)),
    ...
    detectPlatformFeatures: function () {
      ...
      for (
        Platform.hasWebAudioContext =
          this.isWebAudioContextAvailable() && !Platform.isAndroidStockBrowser,
    ...
    consolidatePlatformKnowledge: function () {
      ...
      ;((o = o || Platform.isIphone3GSDevice),
        ...
        (Platform.isWebAudioEnabled = Platform.hasWebAudioContext && !o))
    },
    ...
    determineResourceBundle: function () {
      ...
      if (!Sys.isDefined(Platform.resourceBundle)) {
        for (
          o.detectPlatformFeatures(), o.consolidatePlatformKnowledge(), o.applyOverrides(), e = 0;
          e < o.AVAILABLE_RESOURCE_BUNDLES.length;
          e++
        )
          if (((i = Platform['_' + o.AVAILABLE_RESOURCE_BUNDLES[e]]), i.requirementsAreMet())) {
            ;((Platform.resourceBundle = i),
              (Platform.resourceBundle.preloadAudio = i.preloadAudio()))
            try {
    ...
    applyFeatureDetectedProperties: function () {
      Platform.resourceBundle.loaderResourceKeys.audio = this.determineAudioConfiguration(
    ...
    determineAudioConfiguration: function (e) {
      ...
      return (
        'webAudio' !== t ||
          Platform.isDesktopDevice ||
          ((i =
            Platform.resourceBundle.audioType && Platform.resourceBundle.audioType.postFix
    ...
    startListeningToUserInput: function () {
      ...
      ;(Sys.isDefined(e.userInputEvents.started) &&
        ...
        Sys.isDefined(e.userInputEvents.canceled) &&
          e.addListener(e.userInputEvents.canceled, e.onUserInputCanceled))
    },
    stopListeningToUserInput: function () {
      var e = this
      ;(Sys.isDefined(e.userInputEvents.started) && e.removeListener(e.userInputEvents.started),
        Sys.isDefined(e.userInputEvents.ended) && e.removeListener(e.userInputEvents.ended),
        Sys.isDefined(e.userInputEvents.move) && e.removeListener(e.userInputEvents.move),
        Sys.isDefined(e.userInputEvents.canceled) && e.removeListener(e.userInputEvents.canceled))
    },
    onUserInputStart: function (e) {
      var t = this
      t.enabled &&
        Sys.UserInputUtils.isCoordinateTarget(t.container.el, e) &&
        ((t.isActiveInputTarget = !0), t.container.addCls(t.CSS.pressed))
    },
        ...
        if (t(29)) {
          var e = t(60),
            ...
            jt = function (t) {
              ...
              for (
                l && f > 2 && (s = a(s, arguments[2], 2)), n = 0, r = y(c.length), i = Mt(this, r);
                r > n;
                n++
              )
                i[n] = l ? s(c[n], n) : c[n]
    ...
    122: [
      function (t, n, r) {
        ...
        function v(t, n, r, e, i, o) {
          ...
          for (var f = t[B]._b, a = c + t[z], s = e(+i), l = 0; l < n; l++)
            f[a + l] = s[o ? l : n - l - 1]
        }
        var p = t(40),
          y = t(29),
        ...
        if (g.ABV) {
          if (
            ...
            for (var Y, q = (N[A] = k[A]), J = O(k), K = 0; J.length > K; )
        ...
        t(36)('split', 2, function (n, r, e) {
          ...
          if (
            ...
            e = function (t, n) {
              ...
              return (
                y === r[c] ? (!l && g.test('')) || v.push('') : v.push(r.slice(y)),
                v[c] > d ? v.slice(0, d) : v
              )
            }
          } else
      ...
      function (t, n, r) {
        ...
        var e = t(40),
          ...
          X = function (t) {
            ...
            return (
              !(this === G && i(W, t) && !i(C, t)) &&
              (!(n || !i(this, t) || !i(W, t) || (i(this, L) && this[L][t])) || n)
            )
          },
          $ = function (t, n) {
          ...
          Q = function (t) {
            for (var n, r = t === G, e = j(r ? C : S(t)), o = [], u = 0; e.length > u; )
        ...
        var e = t(40),
          ...
          a = function (t) {
            return f
              ? function (n, r) {
                  return t(
                    o(u, [].slice.call(arguments, 2), 'function' == typeof n ? n : Function(n)),
                    r
                  )
                }
              : t
            ...
            function s(t, n) {
              ...
              if (r === d) {
                if (((n.delegate = null), 'throw' === n.method)) {
                  if (
                    t.iterator.return &&
                    ((n.method = 'return'), (n.arg = d), s(t, n), 'throw' === n.method)
                  )
                    return A
                  ;((n.method = 'throw'),
              ...
              if ('throw' === i.type)
                return ((n.method = 'throw'), (n.arg = i.arg), (n.delegate = null), A)
              var o = i.arg
              return o
                ? o.done
              ...
              (E.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = u), x in t || (t[x] = 'GeneratorFunction')),
              ...
              (v.prototype = {
                ...
                finish: function (t) {
                  for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                    ...
                    if (r.finallyLoc === t)
                      return (this.complete(r.completion, r.afterLoc), h(r), A)
                  }
                },
                catch: function (t) {
                  for (var n = this.tryEntries.length - 1; n >= 0; --n) {
  ...
  ;(window.core
    ...
    (window.core.effect.Animate = {
      requestAnimationFrame: (function () {
        ...
        if (
          (n &&
            !/requestAnimationFrame\(\)\s*\{\s*\[native code\]\s*\}/i.test(n.toString()) &&
            (e = !1),
          e)
        )
          return function (e, t) {
            ...
            null === o &&
              (o = setInterval(function () {
                var n = +new Date(),
                  e = t
                ;((t = {}), (r = 0))
                for (var i in e) e.hasOwnProperty(i) && (e[i](n), (a = n))
      ...
      start: function (r, i, o, a, u, f) {
        ...
        var A = function (t) {
          var s = !0 !== t,
            d = n()
          if (!e[v] || (i && !i(v)))
            return ((e[v] = null), void (o && o(60 - w / ((d - c) / 1e3), v, !1)))
          if (s)
            for (var q = Math.round((d - m) / (1e3 / 60)) - 1, F = 0; F < Math.min(q, 4); F++)
              (A(!0), w++)
          a && (l = (d - c) / a) > 1 && (l = 1)
          var D = u ? u(l) : l
          ;(!1 !== r(D, d, s) && 1 !== l) || !s
            ? s && ((m = d), core.effect.Animate.requestAnimationFrame(A, f))
            : ((e[v] = null), o && o(60 - w / ((d - c) / 1e3), v, 1 === l || null == a))
        }
        return ((e[v] = !0), core.effect.Animate.requestAnimationFrame(A, f), v)
      }
    }))
})()
;(window.Scroller,
      ...
      t = {
        ...
        zoomTo: function (e, o, _, t, l) {
          ...
          ;(l && (i.__zoomComplete = l),
            i.__isDecelerating &&
              (core.effect.Animate.stop(i.__isDecelerating), (i.__isDecelerating = !1)))
          var n = i.__zoomLevel
        ...
        scrollTo: function (e, o, _, t) {
          ...
          if (
            (l.__isDecelerating &&
              (core.effect.Animate.stop(l.__isDecelerating), (l.__isDecelerating = !1)),
          ...
          ;(l.options.scrollingX
            ? l.options.paging
              ? (e = Math.round(e / l.__clientWidth) * l.__clientWidth)
              : l.options.snapping && (e = Math.round(e / l.__snapWidth) * l.__snapWidth)
            : (e = l.__scrollLeft),
            l.options.scrollingY
              ? l.options.paging
                ? (o = Math.round(o / l.__clientHeight) * l.__clientHeight)
                : l.options.snapping && (o = Math.round(o / l.__snapHeight) * l.__snapHeight)
              : (o = l.__scrollTop),
        ...
        doTouchStart: function (e, o) {
          ...
          if ((o instanceof Date && (o = o.valueOf()), 'number' != typeof o))
          ...
          if (t.__isTracking) {
            ...
            if (t.__isDragging) {
              ...
              if (t.__enableScrollX) {
                ...
                ;(c > g || c < 0) &&
                  (t.options.bouncing
                    ? (c += (r / 2) * this.options.speedMultiplier)
                    : (c = c > g ? g : 0))
              }
              if (t.__enableScrollY) {
                ...
                ;(s > u || s < 0) &&
                  (t.options.bouncing
                    ? ((s += (a / 2) * this.options.speedMultiplier),
                      t.__enableScrollX ||
                        null == t.__refreshHeight ||
                        (!t.__refreshActive && s <= -t.__refreshHeight
                          ? ((t.__refreshActive = !0), t.__refreshActivate && t.__refreshActivate())
                          : t.__refreshActive &&
                            s > -t.__refreshHeight &&
                            ((t.__refreshActive = !1),
              ...
              ;((t.__enableScrollX = t.options.scrollingX && T >= v),
                (t.__enableScrollY = t.options.scrollingY && d >= v),
                n.push(t.__scrollLeft, t.__scrollTop, o),
                (t.__isDragging = (t.__enableScrollX || t.__enableScrollY) && (T >= 5 || d >= 5)),
          ...
          if (o.__isTracking) {
            if (((o.__isTracking = !1), o.__isDragging))
              if (
                ...
                for (
                  var _ = o.__positions, t = _.length - 1, l = t, i = t;
                ...
                if (l !== t) {
                  ...
                  Math.abs(o.__decelerationVelocityX) > c || Math.abs(o.__decelerationVelocityY) > c
                    ? o.__refreshActive || o.__startDeceleration(e)
            ...
            ;(o.__isDecelerating ||
              (o.__refreshActive && o.__refreshStart
                ? (o.__publish(o.__scrollLeft, -o.__refreshHeight, o.__zoomLevel, !0),
                  o.__refreshStart && o.__refreshStart())
                : ((o.__interruptedAnimation || o.__isDragging) && o.options.scrollingComplete(),
                  o.scrollTo(o.__scrollLeft, o.__scrollTop, !0, o.__zoomLevel),
                  o.__refreshActive &&
                    ((o.__refreshActive = !1), o.__refreshDeactivate && o.__refreshDeactivate()))),
        ...
        __publish: function (e, t, l, i) {
          var n = this,
            r = n.__isAnimating
          if (
            (r && (core.effect.Animate.stop(r), (n.__isAnimating = !1)), i && n.options.animating)
          ) {
              ...
              u = function (e, o, _) {
                ;(o === n.__isAnimating && (n.__isAnimating = !1),
                  ...
                  n.options.zooming &&
                    ...
                    n.__zoomComplete && (n.__zoomComplete(), (n.__zoomComplete = null))))
              }
        ...
        __startDeceleration: function (e) {
          ...
          var n = function (e, _, t) {
            ...
            a = function () {
              var e =
                Math.abs(o.__decelerationVelocityX) >= r || Math.abs(o.__decelerationVelocityY) >= r
        ...
        __stepThroughDeceleration: function (e) {
          ...
          if (
            (e ? o.__publish(_, t, o.__zoomLevel) : ((o.__scrollLeft = _), (o.__scrollTop = t)),
            !o.options.paging)
          ) {
            ;((o.__decelerationVelocityX *= 0.95), (o.__decelerationVelocityY *= 0.95))
          }
          if (o.options.bouncing) {
            var n = 0,
              r = 0,
            ...
            ;(_ < o.__minDecelerationScrollLeft
              ...
              : _ > o.__maxDecelerationScrollLeft && (n = o.__maxDecelerationScrollLeft - _),
              t < o.__minDecelerationScrollTop
                ? (r = o.__minDecelerationScrollTop - t)
                : t > o.__maxDecelerationScrollTop && (r = o.__maxDecelerationScrollTop - t),
              0 !== n &&
...
;(Sys.ns('Game'),
  (Game.Scaling = {
    ...
    centerGame: function (e) {
      ...
      ;((t =
        Platform.isSafariBrowser && (Platform.isIOS13Device || Platform.isIOS14Device)
          ? Utils.Platform.getViewportInnerSize()
          : Utils.Platform.getViewportSize()),
        (i =
        ...
        (this.viewport.style.left = Math.round((t.width - o.width * e) / 2) + 'px'),
        (Platform.isMobileDevice || Platform.isTabletDevice) &&
          r &&
          (document.documentElement.clientWidth >= document.documentElement.clientHeight
            ? ((r.style.width = o.width * e + 'px'), (r.style.height = o.height * e + 'px'))
  ...
  (Loader.ResourceHandler = {
    ...
    constructor: function (e) {
      ;((e = e || {}),
        ...
        this.setupData(e),
        this.setupEvents(),
        'function' == typeof e.callback && (this.progressCallback = e.callback),
    ...
    isDeviceDetectionDisabled: function () {
      ...
      'boolean' == typeof e.disableDeviceDetection &&
        Resources.storeData('disableDeviceDetection', e.disableDeviceDetection)
    },
    determineSessionID: function () {
      ...
      return Sys.isDefined(t) && Sys.isDefined(s)
        ...
        : (Sys.isDefined(a) || Sys.utils.goToLobby(1), this.storeSessionID(a), null)
    },
    ...
    determineLobbyURL: function (e) {
      ...
      Sys.isDefined(e)
        ...
        : Sys.isDefined(t.lobbyURL) && Resources.storeData('lobbyUrl', t.lobbyURL)
    },
    ...
    handleServletResponse: function (e) {
      var t = Sys.utils.parseQueryString(e.responseText),
        ...
        s = t.pluginURL,
        r = t.lobbyURL
      ;(Sys.isDefined(a) ? this.storeSessionID(decodeURIComponent(a)) : Sys.utils.goToLobby(1),
        Sys.isDefined(s)
    ...
    addPlatformSpecificResourcesToGenericList: function () {
      ...
      ;(Platform.PlatformManager.determineResourceBundle(),
        Sys.iterate(Platform.resourceBundle.loaderResourceKeys, function (s, r) {
          var o = t[s][r]
          o && (e.push(o), (a += o.size))
        }),
            ...
            l
              ...
              .done(function (e) {
                ...
                Sys.isDefined(s)
                  ...
                  : Resources.storeData(a.name + 'Response', e)
              }),
            (o[a.name] = 0),
            r.push(l))
        }),
    ...
    slownessDetected: function () {
      var e = {
          ...
          label: Services.languageManager.hasText(Language.Keys.btn_casino)
        ...
        t = {
          ...
          label: Services.languageManager.hasText(Language.Keys.btn_reload)
        ...
        a = {
          texts: [
            Services.languageManager.hasText(Language.Keys.loadingTakesLonger)
              ? Services.languageManager.getText(Language.Keys.loadingTakesLonger)
    ...
    initGameIfPossible: function () {
      !this.readData('scriptsAppended') &&
        ...
        (this.fireEvent('notify:resourceHandler.gameAssetsLoaded'), this.appendScriptFiles())
    },
    gameServerInitComplete: function (e) {
      ;(Resources.storeData(
        ...
        Resources.storeData('unParsedGameServerInitResponse', e.responseText),
    ...
    priorityAudioJsonComplete: function (e, t) {
      ...
      ;(Platform.resourceBundle.preloadAudio && this.addAudioToGenericList(a),
    ...
    xmlComplete: function (e, t) {
      if (('languageJSON' === t || 'languageXML' === t) && !e.responseXML)
        throw (
          ...
          new Error('Unable to parse language file xml. Aborting game.')
        )
    ...
    getLanguagePath: function (e, t, a) {
      ...
      return (
        'json' === t
          ...
          : 'xml' === t && (s = '../langlib/' + this.setCorrectCasing(e) + '/' + a),
        s
      )
    },
    getPathFromName: function (e) {
      ...
      return (
        'languageJSON' === t || 'languageXML' === t
          ? (s = this.getLanguagePath(Resources.readData('language').lang, e.type, e.url))
          : 'moneyformat_player' === t
            ? (s = '../../../currencies/' + r.playercurrencyiso.toLowerCase() + '/' + a)
            : 'moneyformat_jackpot' === t
              ? (s = '../../../currencies/' + r.jackpotcurrencyiso.toLowerCase() + '/' + a)
              : ('deviceDetection' !== t && 'deviceDetectionJson' !== t) ||
                (s = (r.staticsharedurl || this.readData('deviceListPath').fallbackPath) + '/' + a),
        s
      )
    },
    setCorrectCasing: function (e) {
      return e.match(/[a-z]{2}_[a-z]{2}/i)
        ? e.substr(0, 2).toLowerCase() + '_' + e.substr(3, 2).toUpperCase()
        : e.toLowerCase()
    },
    createInitQuery: function () {
      ...
      return (
        ...
        {
          serverStr: '/game/NarcosNET/server?sessionId=' + sessionStorage.getItem('sessionId'),
    ...
    buildHistoryUrl: function () {
      ...
      return (
        '/' !== t[t.length - 1] && (t += '/'),
        (t += 'game/history?lang=' + e.lang + '&sessionId=' + Resources.readData('sessionID')),
      ...
      return (
        e.config &&
          ...
          (t = {
            ...
            defaultBettingMode: e.config.bettingMode.defaultBettingMode
          }),
        t
      )
    }
      ...
      switch (e.code) {
        ...
        case i.GREY_OS:
          t.handleGreyListedCombination(
            Services.languageManager.getText(Language.Keys.MGnoOSSupport)
          )
          break
        ...
        case Core.DeviceDetectionCodes.GREY_BROWSER:
          t.handleGreyListedCombination(
            Services.languageManager.getText(Language.Keys.optimisedForVersion, [
              e.preferredBrowser
            ])
          )
          break
        case Core.DeviceDetectionCodes.GREY_BROWSER_VERSION:
          t.handleGreyListedCombination(
            Services.languageManager.getText(Language.Keys.deviceUpdateBrowser)
          )
          break
        case i.BLACK_OS:
    ...
    showDialog: function (e) {
      ...
      ;(this.fireEvent('request:userInputManager.allowPropagation'),
        'stopped' === e.severity || 'slow' === e.severity
          ...
          : this.model.storeData('delayedMessage', this.model.readData('delayedMessages').push(e)))
    },
    hideDialog: function () {
    ...
    show: function () {
      ...
      this.timeout = setTimeout(function () {
        ;(e.logoWrapper.classList.add('logo-wrapper--animate'),
          ...
          e.brandingWrapper.classList.add('branding-wrapper--animate'))
      ...
      ;(this.loaderInner.replaceChild(a, this.loaderDialog),
        ...
        setTimeout(function () {
          ;(t.loaderDialog.classList.add('loader-dialog--show'),
            ...
            t.brandingWrapper.classList.add('branding-wrapper--hidden'))
        }, this.ANIMATION_DELAY))
    },
    hideDialog: function () {
...
;(Sys.ns('Loader'),
  (Loader.ErrorHandler = {
    ...
    handlePluginTimeoutError: function () {
      ...
      ;(Utils.Helpers.logError('GCS_LOAD_ERROR', 404, new Error('Plugin timeout error')),
    ...
    handleRequestError: function (e) {
      ...
      ;(Sys.utils.httpRequestIsOK(e) ? Sys.isDefined(r) && (t = 'server') : (t = 'http'),
        t !== this.readStatus() &&
          ((Sys.isDefined(t) && 20 !== r) ||
            Sys.utils.goToLobby(Utils.CONSTANTS.REASON_CODES.BOOKMARK),
          this[this.errorStatus[t]](),
          this.setStatus(t),
          Utils.Helpers.logError('GCS_LOAD_ERROR', r, new Error(t + ' request error'))))
    },
    ...
    handleRequestError: function (e) {
      ...
      ;(Sys.utils.httpRequestIsOK(e)
        ...
        Sys.isDefined(r) &&
          ...
          (t[t.errorStatus[r]](),
          t.setStatus(r),
          Utils.Helpers.logError('GCS_LOAD_ERROR', s, new Error(r + ' request error'))))
    },
...
;((Sys.UserInput = {
  ...
  defineInputEvents: function () {
    ...
    return (
      Utils.Platform.isTouchSupported() && Platform.isDesktopDevice
        ...
        : Utils.Platform.isTouchSupported()
          ? (t.push('touchstart'), e.push('touchmove'), n.push('touchend'), s.push('touchcancel'))
          : (t.push('mousedown'),
            e.push('mousemove'),
            n.push('mouseup'),
            s.push('mouseout'),
  ...
  activateExclusivity: function (t) {
    ...
    this.readData('exclusivityRequested')
      ? ((e = this.readData('exclusiveQueue')), e.push(t), this.storeData('exclusiveQueue', e))
  ...
  handleInteractionStart: function (t) {
    ...
    ;(this.checkPropagation(t),
      this.isState('deactivated') ||
        ...
        'touchstart' === t.type && (e.identifier = t.targetTouches[0].identifier),
  ...
  handleInteractionMove: function (t) {
    ...
    ;(this.checkPropagation(t),
      !this.isState('deactivated') &&
        ...
        e && this.sendInputEvent(Sys.isDefined(n) ? 'move' : 'hover', t)))
  },
  handleInteractionEnd: function (t) {
    ...
    ;(this.checkPropagation(t),
      !this.isState('deactivated') &&
        ...
        e || (this.removeData('activeInteraction'), this.sendInputEvent('end', t))))
  },
      ...
      Sys.utils
        ...
        .always(function () {
          ;(new Loader.DeviceDetector(),
            ...
            (Game.viewport = Services.scaling = Services.legacy.scaling = new Game.Scaling()),
            (Services.languageManager = Services.legacy.languageManager =
...
;(Sys.ns('Core'),
  (Core.StateHandler = {
        ...
        for (t.runningStateMachine = !0; t.hasStatesInStack(); ) {
          if (!Sys.isEmpty(t.currentState)) {
            for (e in t.currentState.waitEvents)
              if (t.currentState.waitEvents.hasOwnProperty(e) && !t.currentState.waitEvents[e])
    ...
    leaveCurrentState: function () {
      var e = this
      ;(e.fireEvent('notify:stateHandler.leaving' + e.currentState.name + 'State'),
    ...
    processModuleQueue: function () {
      var e,
        t = this,
        n = Game.moduleLoader.getModuleQueueForState(t.currentState.name),
        s = n.length
      for (e = 0; e < s; e++)
        n[e]({
          stateHandler: t,
    ...
    pushState: function (e) {
      ...
      if (this.stateStack.indexOf(e) > -1)
        return void console.error(
          "Trying to insert state '" + e.name + "', that is already in stack"
        )
    ...
    dumpStack: function (e) {
      ...
      if (i.useLogging)
        if (this.currentState) {
          for (
            t = e,
              Sys.each(Object.getOwnPropertyNames(this.currentState.waitEvents), function (e) {
                ;((n = i.currentState.waitEvents[e] ? '*' : ' '),
                  (r += '\n\t\t(' + n + ') ' + e.replace(/\s/g, '')))
              }),
              t += '\nCurrent state:\t' + this.currentState.name + r,
  ...
  (Core.ModuleLoader = {
    ...
    loadModules: function (e) {
      ...
      ;((i.modules = {}),
        Sys.iterate(e, function (e, o) {
          if (
            ((n = Sys.isArray(o.platforms) && -1 === o.platforms.indexOf(r)),
            !Sys.isDefined(i.modules[e]) && !n)
          ) {
            if (((s = i.getClassFromString(o.module)), !Sys.isDefined(s) && !0 === o.optional))
              return
            ;((i.modules[e] = new s({
              name: e,
              ...
              'string' == typeof o.global &&
                ...
                Sys.isDefined(window[o.global]) || (window[o.global] = {}),
                (window[o.global][e] = i.modules[e].controller),
                t && (window[o.global].legacy[e] = i.modules[e].controller)),
              i.applyMixins(
                i.modules[e],
                i.combineMixins(i.modules[e].getMixinDependencies(), o.mixins)
              ))
          }
        }))
    },
    combineMixins: function (e, t) {
      ...
      for (
        Sys.isArray(e)
          ? ((o = e), (a = e.length))
          : ((o = e.hasOwnProperty(u) ? e[u] : e.fallback), (a = (o && o.length) || 0)),
          r = -1;
        ++r < a;
      ...
      if (Sys.isArray(t))
        for (a = t.length, r = -1; ++r < a; ) ((n = t[r]), Sys.isDefined(l[n]) || (l[n] = void 0))
      return l
    },
    applyMixins: function (e, t) {
      var n,
        ...
        d = l.length
      for (o = -1; ++o < c; )
        if (((r = u[o]), (i = t[r] || {}), (n = Mixins[r]), Sys.isDefined(n))) {
          for (a = -1; ++a < d; )
            ((s = l[a]),
              Sys.isDefined(n[s]) &&
                Sys.isDefined(e[s]) &&
          ...
          for (a = -1; ++a < d; )
            ((s = l[a]),
              Sys.isDefined(n[s]) &&
                ...
                this.executeMixinProperties(e[s], n[s].executeOnInstantiation, i))
        }
    },
          ...
          Sys.iterate(i, function (i, r) {
            !Sys.isDefined(r.state) &&
              ...
              (Sys.isArray(r.waitEvents) &&
                ...
                e.registerListenersOnStateHandler(s.controller, r.waitEvents)),
              Sys.isArray(r.queue) && e.updateModuleQueue(t, n[i].name, r.queue))
          })
        }))
    },
    registerListenersOnStateHandler: function (e, t) {
      var n,
        s = t.length
      for (n = -1; ++n < s; )
        this.stateHandler.hasListener(t[n]) || this.stateHandler.registerEvents(t[n])
    },
    updateModuleQueue: function (e, t, n) {
      ...
      Sys.isDefined(i)
        ? ((s = i.indexOf(e)),
          s >= 0
            ? (i.splice.apply(i, [s, 1].concat(n)), (this.stateOrder[t] = i))
            : console.warn(
    ...
    cleanStateQueue: function () {
      ...
      Sys.iterate(e.stateOrder, function (e, t) {
        var n
        for (n = 0; n < t.length; n++)
          ('string' != typeof t[n] && Sys.isDefined(t[n])) || (t.splice(n, 1), n--)
      })
    },
              ...
              ? Sys.isDefined(n.insertBefore)
                ? ((s = t[e].indexOf(n.insertBefore) + 1),
                  s < 0
                    ...
                    : t[e].splice.apply(t[e], [s, 0].concat(n.modules)))
    ...
    getClassFromString: function (e) {
      var t, n, s, i
      if ('string' == typeof e) {
        for (t = e.split('.'), n = window, i = t.length, s = 0; s < i; s++)
  ...
  (Services.Activity = {
    ...
    _setupEvents: function () {
      this.observable.on({
        ...
        'notify:responseParser.bonusProgramWidgetValuesParsed': this.removeActivity.bind(
          this,
          'widgetspin'
        ),
        ...
        'notify:responseParser.freeSpinInitResponseParsed': this.removeActivity.bind(
          this,
          'initfreespin'
        ),
  ...
  (Services.Activity = Sys.extend(Services.Base, Services.Activity, 'Services.Activity')),
  Sys.ns('Services'),
  (Services.Autoplay = {
    ...
    constructor: function (e) {
      ;(Services.Autoplay.superclass.constructor.apply(this, arguments),
        (this._active = !1),
        (this._availableRounds = this._getAvailableRounds(e.initResponse, this.DEFAULT_ROUNDS)),
        (this._available = null !== this._availableRounds),
        (this._rounds = 0),
        (this._stopConditions = this._getDefaultStopConditions(e.initResponse, e.ISO)),
    ...
    showWarningDialog: function () {
      var e,
        ...
        s = n.getText(Language.Keys.autoplay_setting_ifCashDecreasesByWarning),
        i = n.getText(Language.Keys.autoplay_setting_ifCashDecreasesByWarningTouch),
        r = Services.bet.isBetOverlapping()
      ;((e = Platform.isDesktopDevice
        ? {
            title: n.getText(Language.Keys.autoplay_setting_ifCashDecreasesBy),
            text: r ? i : s,
            buttons: [
              {
    ...
    updateStopCondition: function (e) {
      ...
      if (
        ...
        (s.enabled = e.enabled),
        (t = e.attributes),
        !1 === e.active && ((i = null), s.attributes && (s.attributes.value = null)),
        t)
      ) {
        if (
          ((i = e.attributes.value),
          t.required && ((s.active = !0), 'function' == typeof t.validate && !t.validate(i)))
        )
          return
    ...
    resetStopConditions: function () {
      this._stopConditions.forEach(
        function (e) {
          ;(e.attributes
            ? ((e.active = Boolean(e.attributes.required)), (e.attributes.value = e.defaultValue))
            : (e.active = e.defaultValue),
            this.publish('stopConditionChanged', e.id, e.defaultValue),
            Services.settingsManager.storeSetting(e.id, e.defaultValue))
        }.bind(this)
      )
    },
    removeStopCondition: function (e) {
      ...
      return (
        !!t &&
        (this._stopConditions.splice(this._stopConditions.indexOf(t), 1),
    ...
    _validateStopCondition: function (e) {
      ...
      if ('string' != typeof e.id)
        throw new Error("The autoplay stop condition must have a string 'id'.")
      if ('string' != typeof e.text)
        throw new Error("The autoplay stop condition must have a title 'text'.")
      if (void 0 === e.defaultValue)
        throw new Error('The autoplay stop condition must have a default value.')
      if (t) {
    ...
    _freeRoundsEnded: function () {
      var e = this
      e._stopConditions.forEach(function (t) {
        ;(Sys.contains(e.SETTINGS_DISABLED_FREE_ROUNDS, t.id) && (t.enabled = !0),
          e._initResponse.autoplayLossLimitEnabled &&
            'stopAutoplayIfBalanceDecreasedBy' === t.id &&
            ((t.attributes.required = !0), (t.attributes.validate = null)),
          e.updateStopCondition(t))
      })
    }
  }),
  (Services.Autoplay = Sys.extend(Services.Base, Services.Autoplay, 'Services.Autoplay')),
  Sys.ns('Services'),
  (Services.Bet = {
    constructor: function (e) {
      ;(Services.Bet.superclass.constructor.apply(this, arguments),
        (this._ignoreInitialBet = Services.localStorageManager.readData('ignoreInitialBet') || !1),
    ...
    getCustomBetChanges: function (e, t) {
      var n = Resources.readData('queryData'),
        ...
        r = {}
      return (
        Sys.isDefined(s) && -1 !== t.indexOf(s) && (r.defaultBetLevel = s),
        Sys.isDefined(i) && -1 !== e.indexOf(i) && (r.defaultCoinValue = i),
        r
      )
    },
    _freeRoundsSettingsUpdate: function () {
      ;(this._updateBetSettings(Resources.readData('gameServerInitResponse')),
        this._updateAllCoinValues(),
    ...
    _getBetSettings: function (e) {
      ...
      return (
        ...
        Services.localStorageManager.hasData('denomination') &&
          ((n = Number(Services.localStorageManager.readData('denomination'))),
          -1 !== l.indexOf(n) && (a = n)),
        (s = this.getCustomCoinValues(l)),
        (i = this.getCustomBetChanges(s, o)),
        Services.settingsManager.storeSetting('inFreerounds', parseInt(e.freeRoundsLeft, 10) > 0),
        !Services.settingsManager.getSetting('inFreerounds') &&
          s.length &&
          i.defaultCoinValue &&
          ((l = s),
          this._ignoreInitialBet ||
            ...
            Services.localStorageManager.storeData('ignoreInitialBet', (!0).toString()))),
  ...
  (Services.Clock = {
    ...
    _everyMinute: function (e) {
      ...
      t._timeout = setTimeout(
        ...
        (function () {
          var e = new Date()
          return 1e3 * (59 - e.getSeconds()) + (1e3 - e.getMilliseconds())
        })()
      )
    }
  }),
  (Services.Clock = Sys.extend(Services.Base, Services.Clock, 'Services.Clock')),
  Sys.ns('Services'),
  (Services.CustomMessage = {
    ...
    remove: function (e) {
      ;(this.observable.fireEvent('request:customMessages.removeDialog', e),
        this.observable.fireEvent('notify:customMessages.messagesClosed'))
    }
  }),
    ...
    show: function (e) {
      ...
      Sys.isGcmEnabled
        ...
        : (t.readyToShow ||
            ...
            (t.buttons = this._wrapButtonActions(e.buttons || [], t.id)),
            (t.readyToShow = !0)),
          this._currentDialog
    ...
    remove: function (e) {
      ...
      return (
        ...
        (this._currentDialog && this._currentDialog.id === e
          ? (this.publish('hide', e), (this._currentDialog = null), !0)
        ...
        return {
          ...
          action: function () {
            ...
            ;(e.action && e.action.call(e.scope),
              n.publish('hide', t),
              (s = n.next()),
              s ? n.show(s) : n.observable.fireEvent('notify:customMessages.messagesClosed'))
          }
        }
      })
    },
  ...
  (Services.Dialog = Sys.extend(Services.Base, Services.Dialog, 'Services.Dialog')),
  Sys.ns('Services'),
  (Services.Error = {
    constructor: function () {
  ...
  (Services.Error = Sys.extend(Services.Base, Services.Error, 'Services.Error')),
  Sys.ns('Services'),
  (Services.FreeRounds = {
    constructor: function (e) {
  ...
  (Services.FreeRounds = Sys.extend(Services.Base, Services.FreeRounds, 'Services.FreeRounds')),
  Sys.ns('Services'),
  (Services.FreeSpins = {
    constructor: function (e) {
  ...
  (Services.FreeSpins = Sys.extend(Services.Base, Services.FreeSpins, 'Services.FreeSpins')),
  Sys.ns('Services'),
  (Services.Game = {
    constructor: function (e) {
      var t, n
      ;(Services.Game.superclass.constructor.apply(this, arguments),
        ...
        (this._inBaseGame = !0),
        (this._ready = !1),
        (this._modes = [Services.storage.readData('playModeManager.modes')]),
    ...
    _setupEvents: function () {
      this.observable.on({
        ...
        'notify:stateHandler.enteringBonusProgramWidgetState': this._setDisplayMode.bind(
          this,
          'TOPBAR'
        ),
    ...
    showHomeButton: function () {
      this.isHomeButtonAvailable() &&
        ((this._homeButtonVisible = !0), this.publish('showHomeButton'))
    },
    ...
    _setDisplayMode: function (e) {
      this._currentMode !== e &&
        ((this._currentMode = e), this.publish('setDisplayMode', this._currentMode))
    },
    ...
    _onGameConfigurationParsed: function (e, t) {
      ;(Resources.storeData(
        ...
        Resources.storeData('unParsedGameServerInitResponse', t.responseText))
    },
  ...
  (Services.GameRound = {
      ...
      ;(Services.GameRound.superclass.constructor.apply(this, arguments),
        ...
        t.g4mode
          ...
          : void 0 !== t.config &&
            ...
            ? (this._isQuickStopAvailable = t.config.gameParameters.quickStopAvailable)
    ...
    start: function () {
      this.isRoundActive() ||
        ...
        ((this._hasQuickStopped = !1), this._startNewRound(), this.publish('startNewRound'))
    },
    quickStop: function () {
      this.isRoundActive() &&
        this.isQuickStopAvailable() &&
        !this._hasQuickStopped &&
        (this._quickStop(), (this._hasQuickStopped = !0), this.publish('quickStopped'))
    },
  ...
  (Services.GameRound = Sys.extend(Services.Base, Services.GameRound, 'Services.GameRound')),
  Sys.ns('Services'),
  (Services.GameRules = {
    constructor: function () {
      var e,
    ...
    goToGameRules: function () {
      ...
      Platform.isMobileDevice || Platform.isTabletDevice
        ...
        : Platform.isDesktopDevice && window.open(e, 'gameRules').focus()
    },
    getGameRulesURL: function () {
      ...
      return void 0 !== a && 'undefined' !== a
        ...
        : ((r = r.replace(/_sw$/, '')),
          ...
          !1 === o && (e = e.split(s.lang + '.html').join('nortp.' + s.lang + '.html')),
          e)
    },
  ...
  (Services.GameRules = Sys.extend(Services.Base, Services.GameRules, 'Services.GameRules')),
  Sys.ns('Services'),
  (Services.GameSettings = {
    constructor: function (e) {
      ;(Services.GameSettings.superclass.constructor.apply(this, arguments),
        ...
        e.parsedResponse.g4mode
          ? ((this._isQuickSpinAvailable = !1), (this._isQuickSpinActive = !1))
          : void 0 !== e.parsedResponse.config &&
              void 0 !== e.parsedResponse.config.gameParameters &&
              void 0 !== e.parsedResponse.config.gameParameters.quickSpinAvailable
            ? ((this._isQuickSpinAvailable =
                e.parsedResponse.config.gameParameters.quickSpinAvailable),
              void 0 !== e.parsedResponse.config.gameParameters.quickSpinActive &&
                (this._isQuickSpinActive = e.parsedResponse.config.gameParameters.quickSpinActive))
            : ((this._isQuickSpinAvailable = !0), (this._isQuickSpinActive = !1)),
    ...
    setViewState: function (e) {
      'DEFAULT' === e || this._settingsOpened
        ? 'DEFAULT' === e && ((this._settingsOpened = !1), this.publish('settingsClosed'))
  ...
  (Services.GameInformation = {
    constructor: function () {
      var e,
        t = Resources.readData('queryData'),
        n = Utils.CONSTANTS.JURISDICTION_SPECIFIC_CODES.SHOW_GAME_INFORMATION,
        s = !1
      ;(Services.GameInformation.superclass.constructor.apply(this, arguments),
  ...
  (Services.Language = Sys.extend(Services.Base, Services.Language, 'Services.Language')),
  Sys.ns('Services'),
  (Services.Money = {
    MONEY_TYPES: {
      CASH: 'cash',
    ...
    _setupData: function () {
      ;((this._types = Resources.readData('moneyTypes').MONEY_TYPES.split(',')),
        1 === this._types.length
          ? ((this._type = this._types[0]),
            Services.settingsManager.storeSetting('isCash', 'cash' === this._type, !0))
          : (this._type =
              'true' === Services.localStorageManager.readData('isCash')
    ...
    _moneyTypeChanged: function (e, t) {
      ...
      'isCash' === e &&
        ((n = this._type),
        (this._type = t ? this.MONEY_TYPES.CASH : this.MONEY_TYPES.COINS),
        Utils.Helpers.logPlayerInteracted('moneyModeChanged', n, this._type))
    }
  }),
  (Services.Money = Sys.extend(Services.Base, Services.Money, 'Services.Money')),
  Sys.ns('Services'),
  (Services.Paytable = {
    constructor: function () {
    ...
    open: function (e) {
      ...
      ;((this._currentPage = n),
        (this._open && n === t) || ((this._open = !0), this.publish('opened', n)))
    },
    close: function () {
  ...
  (Services.Paytable = Sys.extend(Services.Base, Services.Paytable, 'Services.Paytable')),
  Sys.ns('Services'),
  (Services.PluginMenu = {
    constructor: function () {
    ...
    _adjustPluginTopbar: function () {
      ...
      return (
        ...
        this._open &&
          ...
          (document.getElementById('viewport').style.marginTop = t + 'px'),
        (e = this._getNewHeight(this._sizeOptions, Utils.Platform.getOrientation(), t)),
    ...
    changeHeight: function (e) {
      ...
      return (
        ...
        ((this._sizeOptions = e),
        (t = this._getNewHeight(e, Utils.Platform.getOrientation(), this._getTopBarHeight())),
  ...
  (Services.PluginMenu = Sys.extend(Services.Base, Services.PluginMenu, 'Services.PluginMenu')),
  Sys.ns('Services'),
  (Services.Response = {
    constructor: function (e) {
  ...
  (Services.Response = Sys.extend(Services.Base, Services.Response, 'Services.Response')),
  Sys.ns('Services'),
  (Services.Spin = {
    constructor: function () {
  ...
  (Services.Ticker = Sys.extend(Services.Base, Services.Ticker, 'Services.Ticker')),
  Sys.ns('Services'),
  (Services.Win = {
    constructor: function (e) {
    ...
    _onResponseParsed: function (e) {
      Sys.isDefined(e.wins) &&
        ...
        Services.storage.storeData('cashField.winInCents', this._winCents),
        Services.storage.storeData('cashField.winInCoins', this._winCoins))
    },
        ...
        func: function () {
          ...
          ;(Services.gameSettings.setSetting({
            ...
            Services.gameSettings.getSetting('volume') === e
              ...
              : this.error(t, this.model.ERROR_CODES.UNKNOWN_ERROR))
        }
      },
      NetEntExtend.API.BaseSetter
    ),
        ...
        func: function () {
          ...
          ;((e = t.reduce(function (e, t) {
            return (
              n < 60 &&
                ((n += t.text.length),
                n > 60 && (t.text = t.text.substring(0, t.text.length - n + 60)),
          ...
          Services.moneyManager
            ...
            .then(function (n) {
              ...
              Services.gameRound.isRoundActive()
                ...
                : 'number' == typeof s && (t.push(s), e.success.apply(e, t))
            })
            .fail(function () {
    ...
    createDialogbox: Sys.applyPropertiesIf(
      {
        ...
        func: function () {
          ...
          ;(Object.keys(i).forEach(function (e) {
            'showplugin' === (void 0 !== i[e].action ? i[e].action.toLowerCase() : '') &&
            ...
            Sys.each(i, function (n) {
              ...
              ;((s.action = function () {
                ...
                switch (
                  (e.fireEvent('notify:dialogBoxClosed', this.dialogid, this.buttonid, {
                    name: this.dialogid,
    ...
    removeDialogbox: Sys.applyPropertiesIf(
      {
        ...
        func: function () {
          ;(Services.customMessage.remove('netEntExtend_' + arguments[3]),
            this.success.apply(this, arguments))
        }
      },
      NetEntExtend.API.BaseCall
    ...
    addButton: Sys.applyPropertiesIf(
      {
        ...
        func: function () {
          var e,
            ...
            a = o[3]
          ;(a.image
            ? ((e = document.createElement('img')), (e.src = a.image), (e.alt = a.text))
            : ((e = document.createElement('input')), (e.type = 'button'), (e.value = a.text)),
            (e.name = a.name),
            (e.id = a.id),
            ...
            r.fireEvent('request:userInputManager.allowPropagation'),
    ...
    freeRoundsLeft: Sys.applyPropertiesIf(
      {
        func: function () {
          var e = null,
            t = Array.prototype.slice.call(arguments)
          ;(Services.freeRounds.isActive() && (e = Services.freeRounds.getRemaining()),
            t.push(e),
            this.success.apply(this, t))
        }
      },
        ...
        func: function () {
          var e = this,
            ...
            n =
              Sys.isDefined(t) &&
              t >= 0 &&
              Sys.contains(['FREESPIN', 'SUPERSPIN'], e.model.readData('gameMode'))
                ? t
                : null
    ...
    closeSplash: Sys.applyPropertiesIf(
      {
        ...
        isAvailable: function () {
          var e = this
          return !Services.dialog.isShowing() && e.model.readData('featureSplash.showing')
        },
        func: function () {
          var e = this
    ...
    startSpin: Sys.applyPropertiesIf(
      {
        ...
        isAvailable: function () {
          return (
            !(Services.gameRound.isRoundActive() || Services.dialog.isShowing()) &&
            (Services.bet.getBetCash() <= Services.money.getBalanceCash() ||
  ...
  (Core.NetEntExtendController = {
    ...
    handleIncomingMessage: function () {
      var e,
        ...
        s = arguments[1],
        i = arguments[2]
      if (arguments.length < 3 || 'string' != typeof n || !Sys.isNumber(s) || 'string' != typeof i)
        t.error(arguments, t.model.ERROR_CODES.WRONG_NUMBER_OF_ARGUMENTS)
      else if (Sys.isDefined(t.API[n]) && Sys.isDefined(t.API[n][i]))
        if (
          ((e = t.API[n][i]),
          (Platform.isDesktopDevice && -1 === e.platforms.indexOf('desktop')) ||
            ((Platform.isMobileDevice || Platform.isTabletDevice) &&
              -1 === e.platforms.indexOf('mobile')))
        )
          t.error(arguments, t.model.ERROR_CODES.FUNCTIONALITY_NOT_AVAILABLE)
    ...
    onReloadBalanceResponse: function (e) {
      ...
      s
        ...
        : Sys.isNumber(i) &&
          (Services.moneyManager.setBalance(i), t.success.apply(t, t.addParamsToArgument(n, i)))
    },
  ...
  (Core.PostmanController = {
    ...
    onMessage: function (e) {
      e.data.moduleId
        ? this.fireEvent('notify:' + e.data.moduleId + '.notification', e.data)
    ...
    setupPlugin: function () {
      var e,
        t = this
      this.pluginURL
        ? (this.enableSwedenPlugin && this.loadPluginForSwedenIntegration(),
        ...
        : (this.fireEvent('notify:postman.ready'), (this.IS_READY = !0))
    },
    handlePluginReadyCall: function (e) {
      ...
      'call' === e[0] &&
        ...
        Sys.isDefined(t) && Sys.isDefined(n) && this.fireEvent('request:pluginMenu.init', t, n, s),
        this.sendMessage(['success', e[1]]))
    },
    handleIncomingMessage: function (e) {
      this.pluginURL && !this.IS_READY
        ? this.handlePluginReadyCall(e)
        : this.fireEvent.apply(this, ['request:NetEntExtend.newMessage'].concat(e))
    },
    sendMessage: function (e) {
      ;(Utils.Platform.inIframe() && window.parent.postMessage(e, '*'),
        this.iframe &&
          ...
          this.hiddenIframeForSweden &&
            this.hiddenIframeForSweden.contentWindow.postMessage(e, '*')))
    },
    loadPluginForSwedenIntegration: function () {
      ...
      ;((this.hiddenIframeForSweden = document.createElement('iframe')),
        ...
        (this.cssPath =
          (this.swedenButtonPluginHost
            ? this.swedenButtonPluginHost
            : 'https://static-shared.casinomodule.com') + '/sweden-plugin/origin.css'),
    ...
    getStateChanges: function () {
      ...
      return {
        ...
        beforeStopping: {
          queue: [
            function (t) {
              ;(!e.hasImmediate() && e.readData('shouldShowDialogs')) ||
                t.stateHandler.pushState(t.states.showingCustomMessages)
            }
          ]
        },
        setupGame: {
        ...
        noWinPresentation: {
          queue: [
            function (t) {
              ;(!e.hasDialogs() && e.readData('shouldShowDialogs')) ||
                t.stateHandler.pushState(t.states.delayBeforeShowingMessages)
            }
          ]
        }
      }
  ...
  (Core.CustomMessagesController = {
    ...
    onShowDialogRequest: function (e) {
      ...
      ;(delete t.immediate,
        this.model.readData('isIdle')
          ? (this.model.hasDialogsToWaitFor() && this.model.addDialogToWaitFor(t.id),
    ...
    onEnteringIdleState: function () {
      ;(this.model.storeData('isIdle', !0),
        this.model.readData('shouldShowDialogs') && this.showDialogs(this.model.popAll()))
    },
    ...
    onUserInputEnd: function (e) {
      Sys.UserInputUtils.isCoordinateTarget(Game.stage.getGameContainer(), e) &&
        (clearTimeout(this.delayTimeout), this.fireEvent('notify:customMessages.delayComplete'))
    },
    ...
    onDialogShown: function (e) {
      Sys.isDefined(e) &&
        ...
        this.model.hasDialogsToWaitFor() || this.fireEvent('notify:customMessages.messagesClosed'))
    },
        ...
        ? e.forEach(function (e) {
            ;(t.model.addDialogToWaitFor(e.id),
              Services.settingsManager.getSetting('autoPlayNrSpins') > 0 &&
                (t.isErrorMessage(e.messageCode) || e.stopAutoplay) &&
                t.fireEvent('request:autoPlayer.stop'),
              Services.dialog.show(e),
              (e.messageCode !== t.ERRORS.DISPLAY_IMMEDIATELY_CLOSE &&
                e.messageCode !== t.ERRORS.DISPLAY_ON_IDLE_CLOSE) ||
                t.fireEvent('notify:customMessages.fatalMessageShowing', e.messageCode, e.text))
          })
    ...
    isErrorMessage: function (e) {
      var t,
        n = this
      for (t in n.ERRORS) if (n.ERRORS.hasOwnProperty(t) && e === n.ERRORS[t]) return !0
      return !1
    },
    ...
    sendAction: function (e, t, n) {
      ...
      ;(this.fireEvent('notify:serverManager.actionRequestSent', e),
        Sys.utils
          ...
          .fail(function (t) {
            ;(this.fireEvent('notify:serverManager.serverErrorReceived', t),
              this.fireEvent('request:errorManager.handleRequestError', t),
              this.fireEvent('notify:serverManager.actionRequestError', e),
  ...
  (Core.ServerManagerModel = {
    ...
    getRequestURL: function (e) {
      ...
      return this.doIntegrationSpecificRequestUrlUpdates(apiurl)
    },
  ...
  (Core.MoneyManagerController = {
    ...
    onSettingChanged: function (e, t) {
      'betLevel' === e
        ...
        : 'denomination' === e && this.model.setDenomination(t) && this.notifyBetChange()
    },
    ...
    reloadBalance: function () {
      var e = this,
        t = new Sys.Deferred(),
        n = function () {
          ;(e.removeListener('notify:responseParser.reloadBalanceParsed'),
            e.removeListener('notify:serverManager.reloadBalanceRequestFailed'))
        }
      return (
        this.addListener('notify:responseParser.reloadBalanceParsed', function (s) {
  ...
  (Core.MoneyManagerModel = {
    ...
    setupData: function () {
      ...
      ;(this.setupMoneyHandling(),
        ...
        this.storeData('inFreeRounds', parseInt(e.freeRoundsLeft, 10) > 0),
    ...
    setBalance: function (e) {
      ...
      return (
        ...
        this.storeData('playerBalanceCoins', Math.floor(t / this.readData('denomination'))),
        !0)
      )
    },
    setBetLevel: function (e) {
      ...
      return (
        ...
        this.storeData('playerBetCents', t * this.readData('denomination')),
        !0)
      )
    },
    setDenomination: function (e) {
      return (
        ...
        this.storeData('playerBetCents', this.readData('playerBetCoins') * e),
        this.storeData('playerBalanceCoins', Math.floor(this.readData('playerBalanceCents') / e)),
        !0)
      )
    },
    getBalanceCents: function () {
  ...
  (Core.SettingsManagerController = {
    ...
    storeSetting: function (e, t, n, s) {
      ...
      r.model.isLocked(e) ||
        ...
        i[e] !== t &&
          ...
          n &&
            Services.localStorageManager.storeData(e, 'string' == typeof t ? t : JSON.stringify(t)),
          s || r.fireEvent('notify:settingsManager.settingChanged', e, t)))
    },
    ...
    lockSetting: function (e, t) {
      ...
      ;(Sys.isArray(n[e]) || (n[e] = []),
        Sys.contains(n[e], t) ||
          ...
          1 === n[e].length && this.fireEvent('notify:settingsManager.settingLocked', e)))
    },
    unlockSetting: function (e, t) {
      ...
      Sys.isArray(n[e]) &&
        ...
        this.model.storeData('lockedSettings', n),
        0 === n[e].length && this.fireEvent('notify:settingsManager.settingUnlocked', e))
    },
    ...
    handleInfoResponse: function (e) {
      ...
      Sys.isDefined(r) && r.msuntiltimeout <= 0
        ? ((s = Math.round(r.duration / 60 / 60 / 10) / 100),
          r.totalwin >= 0
            ? ((n = r.totalwin), (t = Language.Keys.rc_checkPlayingWon))
            : ((n = Sys.utils.toInt(-r.totalwin)), (t = Language.Keys.rc_checkPlayingLost)),
          i.requestDialog(
  ...
  (Core.RealityCheckModel = {
      ...
      ;(Sys.utils.toInt(e.freeRoundsLeft) > 0 && (t = !1),
        ...
        t &&
          (Sys.isDefined(e['rc.msuntiltimeout'])
            ? (this.storeData('msUntilTimeout', Sys.utils.toInt(e['rc.msuntiltimeout'])),
    ...
    isTimeToDoRealityCheck: function () {
      ...
      return !(
        ...
        ((e = this.readData('lastCheckTime') + this.readData('msUntilTimeout') <= Date.now()),
  ...
  (Core.KeepAliveModel = {
    ...
    setupData: function () {
      ...
      s &&
        Sys.utils.isUrl(t) &&
        parseInt(n, 10) >= 5 &&
        (this.storeData('url', Sys.utils.appendParameterToQuery(t, 'sessId=' + s)),
        ...
        n = {
          ...
          action: function () {
            ;(e.fireEvent('notify:dialogBoxClosed', {
              ...
              e.complete(),
              Sys.utils.goToLobby(Utils.CONSTANTS.REASON_CODES.WANTS_TO_PLAY_FOR_REAL))
          },
          primary: !0
        }
      return {
  ...
  (Core.ErrorManagerModel = {
    ...
    getDialogConfig: function (e) {
      ...
      return ((t = Sys.isDefined(n[e]) ? n[e] : n.generic), (t.errorCode = e), t)
    },
    setUpOutOfMoneyErrorConfig: function () {
      ...
      return (
        i >= r
          ? s && o
            ? ((e = Services.languageManager.getText(Language.Keys.deposit)),
              (t = [
                {
                  type: 'deposit'
                },
          ...
          : ((e = Services.languageManager.getText(Language.Keys.depositPlay)),
            (t =
              s && o
                ? [
                    {
  ...
  (Core.ErrorManagerController = {
    ...
    showDialog: function (e) {
      ...
      ;(this.fireEvent('notify:errorManager.error', t, Services.languageManager.getText(t)),
        Services.dialog.show(e))
    },
    ...
    handleError: function (e) {
      ;(Utils.Helpers.logError('GCS_RUNTIME_ERROR', e, new Error('Runtime error')),
    ...
    handleClientOutOfMoneyError: function () {
      ...
      ;((e.buttons = this.getButtons(e.buttons)),
        Utils.Helpers.logError('GCS_RUNTIME_ERROR', 402, new Error('Client out of money error')),
        this.showDialog(e))
    },
    getDialogConfig: function (e) {
...
;((Core.ErrorManagerController = Sys.extend(
  ...
  (Core.LocalStorageManagerModel = {
    ...
    getAllData: function () {
      for (var e = this, t = {}, n = 0, s = e._getKeyFromStorage(n); s; )
        (0 === s.indexOf(e.accessKey) && (t[s.replace(e.accessKey, '')] = e._getItemFromStorage(s)),
          ++n,
  ...
  (Core.AutoPlayerController = {
    ...
    resume: function () {
      ...
      this.model.isState('PAUSED') &&
        ...
        e.model.readData('spinning') || (e.playRound(), e.model.isState('STOPPING') && e.stop()),
    ...
    play: function () {
      ...
      !e.model.isState('PLAYING') &&
        ...
        e.fireEvent('request:spinButton.addDisplayType', 'autoPlayStop'),
    ...
    onSpinButtonClicked: function (e) {
      return (
        (!Sys.isDefined(e) || !e.hasOwnProperty('skip') || !0 !== e.skip) &&
    ...
    onLeavingIdleState: function () {
      ...
      ;(e.model.storeData('spinning', !0),
        e.model.isState('WAITING') &&
          (e.fireEvent('request:playModeManager.addMode', 'autoplay'), e.play()),
    ...
    onEnteringWinPresentationState: function () {
      ...
      e.model.isState('STOPPING') &&
        Services.settingsManager.getSetting('autoPlayNrSpins') > 0 &&
        e.fireEvent('request:settingsManager.storeData', 'autoPlayNrSpins', 0)
    },
        ...
        ? (n.model.storeData('nrRounds', t),
          0 === t
            ...
            : (n.fireEvent('notify:autoPlayer.enabled', t),
              ...
              n.fireEvent('request:spinButton.addDisplayType', 'autoPlay'),
              n.fireEvent('request:spinButton.addProperty', 'visibleDuringRound', n.MODULE_NAME),
              n.model.setState('WAITING'),
              n.model.storeData('startingBalance', Services.moneyManager.getBalanceCents())))
        : Sys.contains(
            [
              'stopAutoplayIfBalanceIncreasedBy',
              'stopAutoplayIfBalanceDecreasedBy',
  ...
  (Core.AutoPlayerModel = {
    ...
    storeData: function (e, t) {
      ;(Core.AutoPlayerModel.superclass.storeData.apply(this, arguments),
        'nrRounds' === e && Services.storage.storeData('autoPlayer.roundsLeft', t))
    },
    ...
    shouldStopAutoplay: function (e) {
      ...
      return (
        Sys.isObj(e.wins) && ((t = e.wins.cents), (n = e.wins.centsTotal)),
        !!(i && e.credit >= s + i) ||
          !!(r && e.credit - l < s - r) ||
          (!0 === o && (t > 0 || n > 0)) ||
          (a && (t >= a || n >= a))
    ...
    processServerResponse: function (e) {
      var t = e.gamestate || {}
      ;(!this.isState('STOPPED') && this.shouldStopAutoplay(e) && this.setState('STOPPING'),
          ...
          queue: [
            function (t) {
              Services.freeRounds.getRemaining() > 0 &&
                ...
                t.stateHandler.pushState(t.states.freeRoundsDialog)
            }
          ]
        },
        stopped: {
          queue: [
            function (e) {
              Services.freeRounds.isActive() &&
                ...
                e.stateHandler.pushState(e.states.checkForAdditionalFreeRounds)
            }
          ]
        },
  ...
  (Core.Slots.FreeRoundsController = {
    ...
    startFreeRounds: function () {
      ;((this.freeRoundsStarted = !0),
        ...
        this.fireEvent('notify:freeRounds.started', Services.freeRounds.getRemaining()),
        this.setFreeroundModeParameter(!0),
        this.model.storeData('hasShownSplash', !0),
        this.model.storeData('totalFreeRounds', Services.freeRounds.getRemaining()))
    },
              ...
              : this.bonusProgramWidgetActive
                ...
                : (this.showFreeRoundsEndDialog(function () {
                    t.showEnforcedContinueDialog(function () {
                      ;(t.fireEvent('notify:freeRounds.reInitResponseReceived', e),
                        t.fireEvent('notify:dialogBoxClosed', {
                  ...
                  t.fireEvent('request:cashField.showBasicCashValues')),
            this.requestCounterUpdate(),
            this.notifyFreeRoundsLeft(),
            this.setFreeroundModeParameter(!0))
          : n
    ...
    showExtraFreeRoundsDialog: function () {
      ...
      e.requestDialog({
        ...
        text: Services.languageManager.getText(Language.Keys.freeRoundsExtraWon, [
    ...
    showFreeRoundsReloadDialog: function () {
      ...
      e.requestDialog({
        ...
        text:
          Services.languageManager.getText(Language.Keys.roundsUseAcctMoney) +
          ' ' +
    ...
    showEnforcedContinueDialog: function (e) {
      ...
      t.requestDialog({
        ...
        text: Services.languageManager.getText(Language.Keys.haveFreeRounds, [
          Services.freeRounds.getRemaining()
        ]),
        buttons: [
          {
          ...
          queue: [
            function (s) {
              e.bonusProgramWidgetEnabled() &&
                t &&
                'spin' === n &&
                s.stateHandler.pushState(s.states.bonusProgramWidget)
            }
          ]
        },
        checkForAdditionalFreeRounds: {
  ...
  (Core.Slots.BonusProgramWidgetModel = {
    ...
    setBonusProgramData: function (e) {
      ;(this.storeData('bonusProgramWidgetEnabled', Boolean(e.freeRoundWidgetEnabled)),
        this.storeData('bonusProgramWidgetGameId', e.freeRoundWidgetGameId),
        this.storeData('bonusProgramWidgetSections', e.freeRoundWidgetSections),
        this.storeData('nextAction', e.nextaction))
    },
  ...
  (Core.Slots.BonusProgramWidgetController = {
    ...
    initBonusProgramWidget: function () {
      ...
      ;(this.view.initViewData(),
        ...
        this.fetchWidgetVariants(n, s, r, function (r) {
          ...
          ;((o = t.parseVariantsResponse(r, n, s, e, i)), t.startBonusProgramWidget(o))
        }))
    },
    ...
    reInit: function (e) {
      ;(this.model.setBonusProgramData(e),
        this.model.bonusProgramWidgetEnabled() && this.initBonusProgramWidget())
    },
      ...
      switch (e.action) {
        case 'widgetReady':
          ;(this.notifyOrientation(Utils.Platform.getOrientation()),
            ...
            this.sendMessage('soundSettingChange', Services.gameSettings.getSetting('volume')),
            this.sendMessage('defaultValues', {
              operatorId: 'netent', //s.operatorId,
              gameId: s.gameId,
    ...
    setIframeContainerHeight: function () {
      var e = Sys.utils.toInt(
        Environment.determineResolution().resolution.height +
          (Platform.isTabletDevice ? 0 : Environment.getSpaceBelowGame())
      )
  ...
  (Core.Slots.ServerManagerController = {
    ...
    sendAction: function (e, t) {
      ;((e = 'nextAction' === e ? this.model.readData('nextAction') : e),
        Core.Slots.ServerManagerController.superclass.sendAction.call(this, e, t))
    },
  ...
  (Core.Slots.ServerManagerModel = {
    ...
    setupData: function () {
      var e,
        ...
        n,
        s = this
      ;(Core.Slots.ServerManagerModel.superclass.setupData.apply(s, arguments),
        (e = Resources.readData('gameServerInitResponse')),
  ...
  (Core.ResponseParserController = {
    ...
    init: function () {
      ...
      ;(Core.ResponseParserController.superclass.init.apply(this, arguments),
        this.doIntegrationSpecificResponseHandling(this.parseServerResponse(e)))
    },
    setupEvents: function () {
      this.on({
  ...
  (Core.Slots.ResponseParserController = {
    ...
    parseServerResponse: function (e) {
      var t,
        n = this,
        s = Core.Slots.ResponseParserController.superclass.parseServerResponse.call(n, e),
          ...
          ? ((s.rs = this.sortReelSets(s.rs, i.expectedReelSetOrder)),
            ...
            s.ws
              ? ((s.wins = n.parseWinSituations(s, t)),
                (s.wins.winType = n.setWinType(s.wins.coins, Services.moneyManager.getBetCoins())),
    ...
    getCurrentGameState: function (e) {
      ...
      return (
        e.gamestate.current
          ? t.model.storeData('currentServerGameState', e.gamestate.current)
          : t.model.storeData('currentServerGameState', e.gamestate),
        n ||
          ('basic' === (n = t.model.readData('currentServerGameState')) &&
            t.fireEvent('request:playModeManager.addMode', 'basic')),
        n
      )
    },
        ...
        if (
          ...
          for (s = 0; Sys.isDefined(e[n].pos['i' + s]); s++)
            ((r = {}),
              ...
              (r = Sys.apply(r, t[r.reelIndex].symbols[r.symbolIndex])),
              o[n].positions.push(r))
          o[n].positions.sort(this.sortSymbols)
        }
        for (
          i = 0;
          Sys.isDefined(e[n].types['i' + i]) && Sys.isDefined(e[n].types['i' + i].wintype);
          i++
        )
          ((o[n].wins.type = e[n].types['i' + i].wintype),
            'coins' === e[n].types['i' + i].wintype
              ...
              : 'freespins' === e[n].types['i' + i].wintype &&
                ((o[n].wins.freespins = e[n].types['i' + i].freespins),
          ...
          queue: [
            function (t) {
              e.isEnforcementRequired() &&
                e.isNewRound() &&
                t.stateHandler.pushState(t.states.minimumRoundTimeEnforcement)
            }
          ]
        }
      }
  ...
  (Core.G4Model = {
      ...
      ;(this.storeData('isG4', e.g4mode),
        ...
        e.g4mode
          ...
          : this.isG4PropertyDefined() &&
            (this.storeData('g4RoundTimeLimit', e.config.gameParameters.minimumRoundDuration),
            this.storeData('g4QuickSpinActive', e.config.gameParameters.quickSpinActive),
            this.storeData('g4QuickSpinAvailable', e.config.gameParameters.quickSpinAvailable),
            this.storeData('g4QuickStopAvailable', e.config.gameParameters.quickStopAvailable),
            this.storeData('g4ClockRequired', e.config.gameParameters.clockRequired)),
    ...
    isEnforcementRequired: function () {
      var e = this
      return e.readData('isG4') || !(void 0 === e.readData('g4RoundTimeLimit'))
    },
    ...
    getMinimumTimeLeft: function () {
      var e = this.getRoundStartTime() + this.readData('g4RoundTimeLimit'),
        t = e - Date.now()
      return t > 0 ? t : 0
    },
    isNewRound: function () {
    ...
    initG4IfActive: function () {
      ...
      ;(t.model.readData('isG4') || t.model.isG4PropertyDefined()) &&
        ...
        t.model.readData('disabledDuringRound') &&
          t.fireEvent('request:spinButton.addProperty', 'disabledDuringRound', t.MODULE_NAME))
    },
      ...
      Sys.each(e, function (e) {
        void 0 !== e.enabled &&
          (e.enabled
            ...
            : e.enabled || t.dispatchRequestDisableSettingEvent(e.name, e.offValue))
      })
    },
      ...
      Sys.each(e, function (e) {
        void 0 !== e.enabled &&
          (e.enabled
            ...
            : e.enabled || t.dispatchRequestDisableModuleEvent(e.name))
      })
    },
    dispatchRequestDisableSettingEvent: function (e, t) {
      var n = this
      ;(Sys.isDefined(t) && n.fireEvent('request:settingsManager.storeValue', e, t),
        n.fireEvent('request:settingsManager.disableSetting', e),
        n.fireEvent('request:settingsManager.lockSetting', e, n.MODULE_NAME))
    },
  ...
  (Interface.utils.InteractiveContainer = {
    ...
    init: function (t) {
      ...
      ;((t = t || {}),
        ...
        (e.keyboardResult = {}),
        Interface.utils.InteractiveContainer.superclass.init.apply(e, arguments))
    },
    ...
    setValue: function (t, e) {
      ...
      Sys.isNumber(t) &&
        ((n = {
          formattedInputField: Services.money.format(Sys.utils.toInt(t), {
            decimals: 0,
            useCurrencySign: !0
          }),
    ...
    onUserInputStart: function (t) {
      this.wasInitialInputTarget =
        Sys.UserInputUtils.isCoordinateTarget(this.buttonWrapper.el, t) && this.enabled
    },
    ...
    updateButtonText: function () {
      ...
      t.keyboardResult.value > 0
        ...
        : ((e.el.textContent = t.buttonText), e.removeCSSClass('interactive_pushed'))
    }
  }),
  ...
  Sys.apply(Loader.ResourceHandler.prototype, {
    addPlatformSpecificResourcesToGenericList: function () {
      ...
      ;(Platform.PlatformManager.determineResourceBundle(),
        ...
        Object.keys(Platform.resourceBundle.loaderResourceKeys).forEach(function (s) {
...
;(Sys.ns('Integration'),
  ...
  Sys.openBetMode
    ...
    : Sys.openBetPlayForFunMode && Integration.applyOpenBetLanguageOverrides())
;(Sys.ns('Integration.GCM'),
  ...
  (window.setViewportHidden = function (e) {
    ...
    null !== t && Sys.isDefined(t) && ((n = 1), e && (n = 0.01), (t.style.opacity = n))
  }),
  (Integration.GCM.Proxy = {
    ...
    constructor: function () {
      ...
      ;(Integration.GCM.Proxy.superclass.constructor.call(t),
        ...
        (n = t.getIframe()),
        null !== n && Sys.isDefined(n) && ((n.style.zIndex = 10), (n.style.position = 'fixed')),
        t.on({
          'notify:resourceHandler.gameAssetsLoaded': t.onGameLoadedSuccessfully.bind(t),
          'request:gcmProxy.updateProgress': t.simulateLoading.bind(t),
          ...
          'notify:resourceHandler.animationComplete': t.onLoadAnimationClosed.bind(t),
    ...
    processServerResponse: function (e) {
      var n = this,
        t = e.openbet
      ;((n.freeBetBalance =
        Sys.isDefined(t) && Sys.isDefined(t.freebets) ? Number(t.freebets) : n.freeBetBalance),
    ...
    updateBalanceInUI: function () {
      ...
      ;(this.balanceUpdatedWithNewRound || this.gcmCoreInstance.balancesUpdate(e),
      ...
      ;(i.disableUI(),
        ...
        e.RGIError
          ? ((t = com.openbet.gcm.xmlutil),
            (a = t.getErrorInfoFromRGIXml(decodeURIComponent(e.RGIXML))),
          ...
          : ((e = Sys.applyIf(e, {
            ...
            'MULTI_CHOICE_DIALOG' === e.category &&
              (Sys.isDefined(i.actionsOfCurrentDialog)
                ? ((n = !1), i.multiChoiceGameDialogsQueue.push(e))
                : ((i.actionsOfCurrentDialog = e.actions),
                  i.exclusivityEnable ||
                    (i.fireEvent('request:userInputManager.activateExclusivity', i.MODULE_NAME),
                    i.fireEvent('request:quickSettingsMenu.externalDeactivate', i.MODULE_NAME),
                    i.fireEvent('request:spinButton.hide', i.MODULE_NAME),
    ...
    configureGameForGcm: function () {
      ...
      ;(Services.response.on('response', e.processServerResponse.bind(e)),
        ...
        Services.paytable.on('opened', e.notifySettingChangeToUI.bind(e, 'PAYTABLE', !0)),
        Services.paytable.on('closed', e.notifySettingChangeToUI.bind(e, 'PAYTABLE', !1)),
        Services.gameRules.on('opened', e.notifySettingChangeToUI.bind(e, 'ABOUT', !0)),
        Services.gameRules.on('closed', e.notifySettingChangeToUI.bind(e, 'ABOUT', !1)),
    ...
    resume: function (e) {
      ...
      try {
        ;(i && 1 === t.actionsOfCurrentDialog.length && !Sys.isDefined(a) && (a = 0),
          i && Sys.isDefined(t.actionsOfCurrentDialog[a])
            ? t.actionsOfCurrentDialog[a]()
            : t.shouldRevertRound &&
              (t.fireEvent('request:moneyManager.revertBet'),
              t.fireEvent('request:spin.activateDefaultOutcome', 'basic'),
              t.updateBalanceInUI()))
      } finally {
        t.actionsOfCurrentDialog = void 0
      }
      t.multiChoiceGameDialogsQueue.length > 0
        ? ((n = t.multiChoiceGameDialogsQueue.shift()), t.handleError(n))
        : ((t.exclusivityEnable = !1),
          t.fireEvent('request:userInputManager.deactivateExclusivity', t.MODULE_NAME),
          t.fireEvent('request:quickSettingsMenu.externalActivate', t.MODULE_NAME),
  ...
  Sys.apply(Integration.GCM.Proxy.prototype, {
    registerAvailableOptions: function () {
      ...
      ;(Narcos.originalGCMProxyRegisterAvailableOptions.apply(e, arguments),
        e.addListener('notify:responseParser.responseParsed', e.processServerResponse),
        e.addListener('notify:lockUp.updateInitialWin', e.updateInitialLockUpWin))
    },
    processServerResponse: function (e) {
      var r = this,
    ...
    updateInitialLockUpWin: function () {
      var e = this
      e.firstLockUpWin && ((e.latestWin = e.firstLockUpWin), e.onShowWin())
    }
  }))
;(Sys.ns('Integration.GCM'),
    ...
    handleRequestError: function (e) {
      ...
      ;(Sys.utils.httpRequestIsOK(e)
        ...
        Sys.isDefined(r) &&
          ...
          (t[t.errorStatus[r]](),
          t.setStatus(r),
          Utils.Helpers.logError('GCS_LOAD_ERROR', s, new Error('GCM ' + r + ' error'))))
    }
  }),
  ...
  (Archbot.Controller = {
    ...
    setupArchbotEvents: function () {
      ;(Sys.isDefined(this.view) &&
        ...
        this.addListener(
          'view:sendItem',
          this.fireEvent.bind(this, 'request:archBotGUI.saveItem', this.MODULE_NAME)
        )),
        this.addListener(
