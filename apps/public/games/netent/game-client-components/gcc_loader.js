loadjs = (function () {
  ...
  function h(t, r, i, c) {
    ...
    ;((c = c || 0),
      /(^css!|\.css$)/.test(t)
        ? ((s = !0), ((o = e.createElement('link')).rel = 'stylesheet'), (o.href = a))
        : /(^img!|\.(png|gif|jpg|svg)$)/.test(t)
          ? ((o = e.createElement('img')).src = a)
          : (((o = e.createElement('script')).src = t), (o.async = void 0 === n || n)),
      !(o.onload =
        o.onerror =
        o.onbeforeload =
          function (e) {
...
let relativeLocation =
  typeof gccLocation === 'undefined' ? '../../../game-client-components' : gccLocation
            ...
            success: function () {
              ...
              loadjs(
                [
                  ...
                  relativeLocation +
                    '/netent_gcc_fullscreen-notifications/fullscreen-notifications.js',
                ...
                'fullscreen',
                {
                  ...
                  success: function () {
                    loadjs(
                      [relativeLocation + '/netent_gcc-netent_game_adapter/game_adapter.js'],
                      'netent_game_adapter'
                    )
                  }
                }
